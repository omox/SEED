...
public class Side implements Serializable {
  ...
  public Side(String sidename, String cd_disp, String cd_disp_row_no, String custom_value) {
    this.custom_value_ = custom_value;
    this.sidename_ = sidename;
   ...
   * @param maintenance
   */
  public Side(int side, String sidename, String cd_disp_no, String disp_row_no, String custom_value, String maintenance) {
    this.side_ = side;
    this.sidename_ = sidename;
    this.custom_value_ = custom_value;
  ...
  /**
   * @param sidename_ 設定する sidename_
   */
