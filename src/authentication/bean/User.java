...
public class User implements Serializable {
   ...
   *
   */
  public User(int user, String id, String pass, String name, String cd_auth, String dt_pw_term, int group, int position, String custom, String logo, String yobi1_, String yobi2_, String yobi3_, String yobi4_, String yobi5_, String yobi6_, String yobi7_, String yobi8_, String yobi9_,
      String yobi10_) {
    this.cd_user_ = user;
    this.id_ = id;
    this.pass_ = pass;
  ...
  /**
   * TODO:いなげや 権限基本情報識別子(管理権限)
   */
  String admin_prefix = "k";

  /**
   * TODO:いなげや 権限基本情報識別子(店舗権限)
   */
  String tenpo_prefix = "t";

  /**
   * TODO:いなげや 権限追加情報識別子(特殊権限)
   */
  String add_prefix = "s";

  /**
   * TODO:いなげや 権限基本情報(店舗権限-店長・主任)
   */
  String tentyo = tenpo_prefix + "1";

  /**
   * TODO:いなげや 権限基本情報(店舗権限-部門担当者)
   */
  ...
  /**
   * TODO:いなげや 特殊権限を持つ、店舗ユーザーの場合Trueを返します。
   */
