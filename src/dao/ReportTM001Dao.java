...
/*		// 必須チェック
		...
		sbSQL.append(" ) where not(CNTR=0 and CNTS=0 and CNTT=0)");
		sbSQL.append(")");
		...
		sbSQL.append("  ,to_char(to_date(T2.STARTDT, 'YYYYMMDD'), 'YY/MM/DD') as STARTDT");
		sbSQL.append("  ,dayofweek(to_date(T2.STARTDT, 'YYYYMMDD')) as STARTDTW");
		sbSQL.append("  ,to_char(to_date(T2.ENDDT, 'YYYYMMDD'), 'YY/MM/DD') as ENDDT");
		sbSQL.append("  ,dayofweek(to_date(T2.ENDDT, 'YYYYMMDD')) as ENDDTW");
