...
public class ReportBT004Dao extends ItemDao {
  ...
  private String createCommand() {
    ...
    sbSQL.append(", DATE_FORMAT(DATE_FORMAT(KKK.HBSTDT, '%y/%m/%d'), '%y/%m/%d') as HBSTDT_K");
    sbSQL.append(", DAYOFWEEK(DATE_FORMAT(KKK.HBSTDT, '%Y%m%d')) as HBSTDT_K_WNUM");
    sbSQL.append(", DATE_FORMAT(DATE_FORMAT(KKK.HBEDDT, '%y/%m/%d'), '%y/%m/%d') as HBEDDT_K");
    sbSQL.append(", DAYOFWEEK(DATE_FORMAT(KKK.HBEDDT, '%Y%m%d')) as HBEDDT_K_WNUM");
    ...
    sbSQL.append(", DATE_FORMAT(DATE_FORMAT(MYCD.HBSTDT, '%y/%m/%d'), '%y/%m/%d') as HBSTDT_M");
    sbSQL.append(", DAYOFWEEK(DATE_FORMAT(MYCD.HBSTDT, '%Y%m%d')) as HBSTDT_M_WNUM");
    sbSQL.append(", DATE_FORMAT(DATE_FORMAT(MYCD.HBEDDT, '%y/%m/%d'), '%y/%m/%d') as HBEDDT_M");
    sbSQL.append(", DAYOFWEEK(DATE_FORMAT(MYCD.HBEDDT, '%Y%m%d')) as HBEDDT_M_WNUM");
