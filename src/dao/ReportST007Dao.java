...
public class ReportST007Dao extends ItemDao {
  ...
  public JSONArray getTOKMOYCDData(HashMap<String, String> map) {
    ...
    if (StringUtils.equals("1", szRinji)) {
      ...
      sbSQL.append(", DATE_FORMAT(REX.ADDDT, '%y/%m/%d') as F5");
      sbSQL.append(", DATE_FORMAT(REX.UPDDT, '%y/%m/%d') as F6");
      ...
      sbSQL.append(", DATE_FORMAT(RNK.ADDDT, '%y/%m/%d') as F5");
      sbSQL.append(", DATE_FORMAT(RNK.UPDDT, '%y/%m/%d') as F6");
