...
public class ReportBM015Dao extends ItemDao {
	...
	// 対象店取得処理
	public Set<Integer> getTenCdAdd(String bmnCd, String moysKbn, String moysStDt, String moysRban, String rankNoAdd,
									String rankNoDel, JSONArray tenCdAdds, JSONArray tenCdDels) {
	...
	// 対象店配列作成
	public ArrayList<String> getTenrankArray(String bmnCd, String moysKbn, String moysStDt, String moysRban, String rankNoAdd,
									String rankNoDel, JSONArray tenCdAdds, JSONArray rankAdds, JSONArray tenCdDels, String saveTenrankArr) {
		ArrayList<String> paramData = new ArrayList<String>();
		String sqlWhere	= "";
		String sqlFrom	= "INATK.TOKRANK ";
	...
	// 対象店取得処理
	public String checkTenCdAdd(String bmnCd, String moysKbn, String moysStDt, String moysRban, String rankNoAdd,
									String rankNoDel, JSONArray tenCdAdds, JSONArray tenCdDels) {
		...
		String[]		jyogaiTen	= new String[]{};
		Set<Integer>	tencds		= new TreeSet<Integer>();
		JSONArray 		checktenCdAdds = new JSONArray();
	 ...
	 * @return arrMap
	 */
	public ArrayList<String> getSuryoArr(String bmnCd, String moysKbn, String moysStDt, String moysRban, String rankNoAdd,
			String rankNoDel, JSONArray tenCdAdds, JSONArray rankAdds, JSONArray tenCdDels, String saveTenrankArr, String sryPtnNo) {
	 ...
	 * @return htsuMap
	 */
	public ArrayList<String> getRtPtArr(String bmncd, String ptnno, String wwmm, String syukbn, String shuno,
												String daicd, String chucd, int htasu, Set<Integer> tencds, String getFlg){
	 ...
	 */
	public JSONArray getST021UpdChk(String moyskbn, String moysstdt, String moysrban, String bmncd, String kanrino, String kanrieno,
			String tenrankarr,		// 全特(ア有/無)_商品.店ランク配列
	 ...
	 * @return htsuMap
	 */
	public ArrayList<String> getST021UpdArr(String moyskbn, String moysstdt, String moysrban, String bmncd, String kanrino, String kanrieno,
											String rankNoAdd,String rankNoDel, JSONArray tenCdAdds, JSONArray rankAdds, JSONArray tenCdDels,
												String tenkaikbn,		// 全特(ア有/無)_商品.展開区分
												String syukbn,			// 全特(ア有/無)_商品.実績率パタン数値
												String jskptnznenmkbn,	// 全特(ア有/無)_商品.実績率パタン前年同月
												String jskptnznenwkbn,	// 全特(ア有/無)_商品.実績率パタン前年同週
	...
	public String getArrMap(HashMap<String, String> map) {
		...
		return sqlcommand += " FROM SYSIBM.SYSDUMMY1";
	}
}
