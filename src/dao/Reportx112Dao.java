...
public class Reportx112Dao extends ItemDao {
	...
	private String createCommand() {
		...
		if(! DefineReport.Button.NEW.getObj().equals(sendBtnid)){
			...
			sbSQL.append(", TO_CHAR(TEN.ADDDT, 'YY/MM/DD')");													// F102 ：登録日
			sbSQL.append(", TO_CHAR(TEN.UPDDT, 'YY/MM/DD')");													// F113 ：更新日
			sbSQL.append(", TO_CHAR(TEN.UPDDT, 'YYYYMMDDHH24MISSNNNNNN') as HDN_UPDDT");						// F114 ：更新日時
			...
			sbSQL.append(" and NVL(TEN.UPDKBN, 0) = 0");
	...
	public String createSqlTen(JSONArray dataArray, HashMap<String, String> map, User userInfo){
		...
		for (int i = 0; i < len; i++) {
			...
			if(valueData.length >= 100 || (i+1 == len && valueData.length > 0)){
				...
				sbSQL.append("merge into INAMS.MSTTEN as T using (select");
				...
				sbSQL.append(", TENCD");
				sbSQL.append(", SEIKAAREAKBN");
				sbSQL.append(", SENGYOKBN");
				sbSQL.append(", SEINIKUKBN");
				sbSQL.append(", TENOPENDT");
				sbSQL.append(", TENCLOSEDT");
				sbSQL.append(", KAISODT1");
				sbSQL.append(", KAISODT2");
				sbSQL.append(", HANBAIBUCD");
				sbSQL.append(", CHIKUCD");
				sbSQL.append(", URIAERACD");
				sbSQL.append(", CHIIKICD");
				sbSQL.append(", YOSANKBN_T");
				sbSQL.append(", TENKN");
				sbSQL.append(", TENAN");
				...
				sbSQL.append(", ADDRKN_B");
				sbSQL.append(", ADDRAN_T");
				sbSQL.append(", ADDRAN_S");
				sbSQL.append(", ADDRAN_M");
				sbSQL.append(", ADDRAN_B");
				sbSQL.append(", MOYORIEKIKN");
				sbSQL.append(", BUSSTOPKN");
				sbSQL.append(", OWNT_NMKN");
				sbSQL.append(", OWNT_ADDRKN_T");
				sbSQL.append(", OWNT_ADDRKN_S");
				sbSQL.append(", OWNT_ADDRKN_M");
				sbSQL.append(", OWNT_ADDRKN_B");
				sbSQL.append(", OWNP_NMKN");
				sbSQL.append(", OWNP_ADDRKN_T");
				sbSQL.append(", OWNP_ADDRKN_S");
				sbSQL.append(", OWNP_ADDRKN_M");
				sbSQL.append(", OWNP_ADDRKN_B");
				sbSQL.append(", OWNO_NMKN");
				sbSQL.append(", OWNO_ADDRKN_T");
				sbSQL.append(", OWNO_ADDRKN_S");
				sbSQL.append(", OWNO_ADDRKN_M");
				sbSQL.append(", OWNO_ADDRKN_B");
				sbSQL.append(", TEL1");
				sbSQL.append(", TEL2");
				sbSQL.append(", TEL3");
				sbSQL.append(", TEL4");
				...
				sbSQL.append(", FAX1");
				sbSQL.append(", FAX2");
				sbSQL.append(", EGYOTM1_STMD");
				sbSQL.append(", EGYOTM1_EDMD");
				sbSQL.append(", EGYOTM1_STHM");
				sbSQL.append(", EGYOTM1_EDHM");
				sbSQL.append(", EGYOTM2_STMD");
				sbSQL.append(", EGYOTM2_EDMD");
				sbSQL.append(", EGYOTM2_STHM");
				sbSQL.append(", EGYOTM2_EDHM");
				sbSQL.append(", AREA_BA");
				sbSQL.append(", AERA_B1YUKA");
				sbSQL.append(", AREA_B1URIBA");
				sbSQL.append(", AREA_1FYUKA");
				sbSQL.append(", AREA_FURIBA");
				sbSQL.append(", AREA_2FYUKA");
				sbSQL.append(", AREA_2FURIBA");
				sbSQL.append(", AREA_3FYUKA");
				sbSQL.append(", AREA_3FURIBA");
				sbSQL.append(", AREA_4FYUKA");
				sbSQL.append(", AREA_4FURIBA");
				sbSQL.append(", PARK_NM_BA");
				sbSQL.append(", PARK_NM_YANE");
				sbSQL.append(", PARK_NM_TOBI");
				sbSQL.append(", PARK_LT_BA");
				sbSQL.append(", PARK_LT_YANE");
				sbSQL.append(", PARK_LT_TOBI");
				sbSQL.append(", PARK_HC_BA");
				sbSQL.append(", PARK_HC_YANE");
				sbSQL.append(", PARK_HC_TOBI");
				sbSQL.append(", ELEVTRFLG");
				sbSQL.append(", ESCALTRFLG");
				sbSQL.append(", SEIKACD");
				sbSQL.append(", STAFFSU");
				sbSQL.append(", MISEUNYOKBN");
				sbSQL.append(", TENAGE");
				sbSQL.append(", URIDAY");
				sbSQL.append(", URIZEN");
				sbSQL.append(", ARARI");
				...
				sbSQL.append(", JMSOU");
				sbSQL.append(", JMGON");
				sbSQL.append(", SVIKFLG");
				sbSQL.append(", SVPWFLG");
				sbSQL.append(", SVATMFLG");
				sbSQL.append(", SVSRFLG");
				sbSQL.append(", SVDIFLG");
				sbSQL.append(", SVSSFLG");
				sbSQL.append(", SVDPEFLG");
				sbSQL.append(", SVOSFLG");
				sbSQL.append(", SVDMFLG");
				sbSQL.append(", SVPTFLG");
				sbSQL.append(", SVAED");
				sbSQL.append(", SVKSFLG");
				sbSQL.append(", MODELCD");
				sbSQL.append(", COMP1");
				sbSQL.append(", COMP2");
				sbSQL.append(", COMP3");
				sbSQL.append(", COMP4");
				sbSQL.append(", COMP5");
				sbSQL.append(", KAITENRT");
				sbSQL.append(", DAISU");
				sbSQL.append(", KENTIKU");
				sbSQL.append("))as RE on (T.TENCD = RE.TENCD)");
				sbSQL.append(" when matched then update set");
				sbSQL.append("  TENCD = RE.TENCD");
				sbSQL.append(", SEIKAAREAKBN = RE.SEIKAAREAKBN");
				sbSQL.append(", SENGYOKBN = RE.SENGYOKBN");
				sbSQL.append(", SEINIKUKBN = RE.SEINIKUKBN");
				sbSQL.append(", TENOPENDT = RE.TENOPENDT");
				sbSQL.append(", TENCLOSEDT = RE.TENCLOSEDT");
				sbSQL.append(", KAISODT1 = RE.KAISODT1");
				sbSQL.append(", KAISODT2 = RE.KAISODT2");
				sbSQL.append(", HANBAIBUCD = RE.HANBAIBUCD");
				sbSQL.append(", CHIKUCD = RE.CHIKUCD");
				sbSQL.append(", URIAERACD = RE.URIAERACD");
				sbSQL.append(", CHIIKICD = RE.CHIIKICD");
				sbSQL.append(", YOSANKBN_T = RE.YOSANKBN_T");
				sbSQL.append(", TENKN = RE.TENKN");
				sbSQL.append(", TENAN = RE.TENAN");
				...
				sbSQL.append(", ADDRKN_B = RE.ADDRKN_B");
				sbSQL.append(", ADDRAN_T = RE.ADDRAN_T");
				sbSQL.append(", ADDRAN_S = RE.ADDRAN_S");
				sbSQL.append(", ADDRAN_M = RE.ADDRAN_M");
				sbSQL.append(", ADDRAN_B = RE.ADDRAN_B");
				sbSQL.append(", MOYORIEKIKN = RE.MOYORIEKIKN");
				sbSQL.append(", BUSSTOPKN = RE.BUSSTOPKN");
				sbSQL.append(", OWNT_NMKN = RE.OWNT_NMKN");
				sbSQL.append(", OWNT_ADDRKN_T = RE.OWNT_ADDRKN_T");
				sbSQL.append(", OWNT_ADDRKN_S = RE.OWNT_ADDRKN_S");
				sbSQL.append(", OWNT_ADDRKN_M = RE.OWNT_ADDRKN_M");
				sbSQL.append(", OWNT_ADDRKN_B = RE.OWNT_ADDRKN_B");
				sbSQL.append(", OWNP_NMKN = RE.OWNP_NMKN");
				sbSQL.append(", OWNP_ADDRKN_T = RE.OWNP_ADDRKN_T");
				sbSQL.append(", OWNP_ADDRKN_S = RE.OWNP_ADDRKN_S");
				sbSQL.append(", OWNP_ADDRKN_M = RE.OWNP_ADDRKN_M");
				sbSQL.append(", OWNP_ADDRKN_B = RE.OWNP_ADDRKN_B");
				sbSQL.append(", OWNO_NMKN = RE.OWNO_NMKN");
				sbSQL.append(", OWNO_ADDRKN_T = RE.OWNO_ADDRKN_T");
				sbSQL.append(", OWNO_ADDRKN_S = RE.OWNO_ADDRKN_S");
				sbSQL.append(", OWNO_ADDRKN_M = RE.OWNO_ADDRKN_M");
				sbSQL.append(", OWNO_ADDRKN_B = RE.OWNO_ADDRKN_B");
				sbSQL.append(", TEL1 = RE.TEL1");
				sbSQL.append(", TEL2 = RE.TEL2");
				sbSQL.append(", TEL3 = RE.TEL3");
				sbSQL.append(", TEL4 = RE.TEL4");
				sbSQL.append(", TEL5 = RE.TEL5");
				sbSQL.append(", FAX1 = RE.FAX1");
				sbSQL.append(", FAX2 = RE.FAX2");
				sbSQL.append(", EGYOTM1_STMD = RE.EGYOTM1_STMD");
				sbSQL.append(", EGYOTM1_EDMD = RE.EGYOTM1_EDMD");
				sbSQL.append(", EGYOTM1_STHM = RE.EGYOTM1_STHM");
				sbSQL.append(", EGYOTM1_EDHM = RE.EGYOTM1_EDHM");
				sbSQL.append(", EGYOTM2_STMD = RE.EGYOTM2_STMD");
				sbSQL.append(", EGYOTM2_EDMD = RE.EGYOTM2_EDMD");
				sbSQL.append(", EGYOTM2_STHM = RE.EGYOTM2_STHM");
				sbSQL.append(", EGYOTM2_EDHM = RE.EGYOTM2_EDHM");
				sbSQL.append(", AREA_BA = RE.AREA_BA");
				sbSQL.append(", AERA_B1YUKA = RE.AERA_B1YUKA");
				sbSQL.append(", AREA_B1URIBA = RE.AREA_B1URIBA");
				sbSQL.append(", AREA_1FYUKA = RE.AREA_1FYUKA");
				sbSQL.append(", AREA_FURIBA = RE.AREA_FURIBA");
				sbSQL.append(", AREA_2FYUKA = RE.AREA_2FYUKA");
				sbSQL.append(", AREA_2FURIBA = RE.AREA_2FURIBA");
				sbSQL.append(", AREA_3FYUKA = RE.AREA_3FYUKA");
				sbSQL.append(", AREA_3FURIBA = RE.AREA_3FURIBA");
				sbSQL.append(", AREA_4FYUKA = RE.AREA_4FYUKA");
				sbSQL.append(", AREA_4FURIBA = RE.AREA_4FURIBA");
				sbSQL.append(", PARK_NM_BA = RE.PARK_NM_BA");
				sbSQL.append(", PARK_NM_YANE = RE.PARK_NM_YANE");
				sbSQL.append(", PARK_NM_TOBI = RE.PARK_NM_TOBI");
				sbSQL.append(", PARK_LT_BA = RE.PARK_LT_BA");
				sbSQL.append(", PARK_LT_YANE = RE.PARK_LT_YANE");
				sbSQL.append(", PARK_LT_TOBI = RE.PARK_LT_TOBI");
				sbSQL.append(", PARK_HC_BA = RE.PARK_HC_BA");
				sbSQL.append(", PARK_HC_YANE = RE.PARK_HC_YANE");
				sbSQL.append(", PARK_HC_TOBI = RE.PARK_HC_TOBI");
				sbSQL.append(", ELEVTRFLG = RE.ELEVTRFLG");
				sbSQL.append(", ESCALTRFLG = RE.ESCALTRFLG");
				sbSQL.append(", SEIKACD = RE.SEIKACD");
				sbSQL.append(", STAFFSU = RE.STAFFSU");
				sbSQL.append(", MISEUNYOKBN = RE.MISEUNYOKBN");
				sbSQL.append(", TENAGE = RE.TENAGE");
				sbSQL.append(", URIDAY = RE.URIDAY");
				sbSQL.append(", URIZEN = RE.URIZEN");
				sbSQL.append(", ARARI = RE.ARARI");
				sbSQL.append(", JMREI = RE.JMREI");
				sbSQL.append(", JMSOU = RE.JMSOU");
				sbSQL.append(", JMGON = RE.JMGON");
				sbSQL.append(", SVIKFLG = RE.SVIKFLG");
				sbSQL.append(", SVPWFLG = RE.SVPWFLG");
				sbSQL.append(", SVATMFLG = RE.SVATMFLG");
				sbSQL.append(", SVSRFLG = RE.SVSRFLG");
				sbSQL.append(", SVDIFLG = RE.SVDIFLG");
				sbSQL.append(", SVSSFLG = RE.SVSSFLG");
				sbSQL.append(", SVDPEFLG = RE.SVDPEFLG");
				sbSQL.append(", SVOSFLG = RE.SVOSFLG");
				sbSQL.append(", SVDMFLG = RE.SVDMFLG");
				sbSQL.append(", SVPTFLG = RE.SVPTFLG");
				sbSQL.append(", SVAED = RE.SVAED");
				sbSQL.append(", SVKSFLG = RE.SVKSFLG");
				sbSQL.append(", MODELCD = RE.MODELCD");
				sbSQL.append(", COMP1 = RE.COMP1");
				sbSQL.append(", COMP2 = RE.COMP2");
				sbSQL.append(", COMP3 = RE.COMP3");
				sbSQL.append(", COMP4 = RE.COMP4");
				sbSQL.append(", COMP5 = RE.COMP5");
				sbSQL.append(", KAITENRT = RE.KAITENRT");
				sbSQL.append(", DAISU = RE.DAISU");
				sbSQL.append(", KENTIKU = RE.KENTIKU");
				...
				sbSQL.append(", RE.SEIKAAREAKBN");
				sbSQL.append(", RE.SENGYOKBN");
				sbSQL.append(", RE.SEINIKUKBN");
				sbSQL.append(", RE.TENOPENDT");
				sbSQL.append(", RE.TENCLOSEDT");
				sbSQL.append(", RE.KAISODT1");
				sbSQL.append(", RE.KAISODT2");
				sbSQL.append(", RE.HANBAIBUCD");
				sbSQL.append(", RE.CHIKUCD");
				sbSQL.append(", RE.URIAERACD");
				sbSQL.append(", RE.CHIIKICD");
				sbSQL.append(", RE.YOSANKBN_T");
				sbSQL.append(", RE.TENKN");
				sbSQL.append(", RE.TENAN");
				...
				sbSQL.append(", RE.ADDRKN_B");
				sbSQL.append(", RE.ADDRAN_T");
				sbSQL.append(", RE.ADDRAN_S");
				sbSQL.append(", RE.ADDRAN_M");
				sbSQL.append(", RE.ADDRAN_B");
				sbSQL.append(", RE.MOYORIEKIKN");
				sbSQL.append(", RE.BUSSTOPKN");
				sbSQL.append(", RE.OWNT_NMKN");
				sbSQL.append(", RE.OWNT_ADDRKN_T");
				sbSQL.append(", RE.OWNT_ADDRKN_S");
				sbSQL.append(", RE.OWNT_ADDRKN_M");
				sbSQL.append(", RE.OWNT_ADDRKN_B");
				sbSQL.append(", RE.OWNP_NMKN");
				sbSQL.append(", RE.OWNP_ADDRKN_T");
				sbSQL.append(", RE.OWNP_ADDRKN_S");
				sbSQL.append(", RE.OWNP_ADDRKN_M");
				sbSQL.append(", RE.OWNP_ADDRKN_B");
				sbSQL.append(", RE.OWNO_NMKN");
				sbSQL.append(", RE.OWNO_ADDRKN_T");
				sbSQL.append(", RE.OWNO_ADDRKN_S");
				sbSQL.append(", RE.OWNO_ADDRKN_M");
				sbSQL.append(", RE.OWNO_ADDRKN_B");
				sbSQL.append(", RE.TEL1");
				sbSQL.append(", RE.TEL2");
				sbSQL.append(", RE.TEL3");
				sbSQL.append(", RE.TEL4");
				sbSQL.append(", RE.TEL5");
				sbSQL.append(", RE.FAX1");
				sbSQL.append(", RE.FAX2");
				sbSQL.append(", RE.EGYOTM1_STMD");
				sbSQL.append(", RE.EGYOTM1_EDMD");
				sbSQL.append(", RE.EGYOTM1_STHM");
				sbSQL.append(", RE.EGYOTM1_EDHM");
				sbSQL.append(", RE.EGYOTM2_STMD");
				sbSQL.append(", RE.EGYOTM2_EDMD");
				sbSQL.append(", RE.EGYOTM2_STHM");
				sbSQL.append(", RE.EGYOTM2_EDHM");
				sbSQL.append(", RE.AREA_BA");
				sbSQL.append(", RE.AERA_B1YUKA");
				sbSQL.append(", RE.AREA_B1URIBA");
				sbSQL.append(", RE.AREA_1FYUKA");
				sbSQL.append(", RE.AREA_FURIBA");
				sbSQL.append(", RE.AREA_2FYUKA");
				sbSQL.append(", RE.AREA_2FURIBA");
				sbSQL.append(", RE.AREA_3FYUKA");
				sbSQL.append(", RE.AREA_3FURIBA");
				sbSQL.append(", RE.AREA_4FYUKA");
				sbSQL.append(", RE.AREA_4FURIBA");
				sbSQL.append(", RE.PARK_NM_BA");
				sbSQL.append(", RE.PARK_NM_YANE");
				sbSQL.append(", RE.PARK_NM_TOBI");
				sbSQL.append(", RE.PARK_LT_BA");
				sbSQL.append(", RE.PARK_LT_YANE");
				sbSQL.append(", RE.PARK_LT_TOBI");
				sbSQL.append(", RE.PARK_HC_BA");
				sbSQL.append(", RE.PARK_HC_YANE");
				sbSQL.append(", RE.PARK_HC_TOBI");
				sbSQL.append(", RE.ELEVTRFLG");
				sbSQL.append(", RE.ESCALTRFLG");
				sbSQL.append(", RE.SEIKACD");
				sbSQL.append(", RE.STAFFSU");
				sbSQL.append(", RE.MISEUNYOKBN");
				sbSQL.append(", RE.TENAGE");
				sbSQL.append(", RE.URIDAY");
				sbSQL.append(", RE.URIZEN");
				sbSQL.append(", RE.ARARI");
				sbSQL.append(", RE.JMREI");
				sbSQL.append(", RE.JMSOU");
				sbSQL.append(", RE.JMGON");
				sbSQL.append(", RE.SVIKFLG");
				sbSQL.append(", RE.SVPWFLG");
				sbSQL.append(", RE.SVATMFLG");
				sbSQL.append(", RE.SVSRFLG");
				sbSQL.append(", RE.SVDIFLG");
				sbSQL.append(", RE.SVSSFLG");
				sbSQL.append(", RE.SVDPEFLG");
				sbSQL.append(", RE.SVOSFLG");
				sbSQL.append(", RE.SVDMFLG");
				sbSQL.append(", RE.SVPTFLG");
				sbSQL.append(", RE.SVAED");
				sbSQL.append(", RE.SVKSFLG");
				sbSQL.append(", RE.MODELCD");
				sbSQL.append(", RE.COMP1");
				sbSQL.append(", RE.COMP2");
				sbSQL.append(", RE.COMP3");
				sbSQL.append(", RE.COMP4");
				sbSQL.append(", RE.COMP5");
				sbSQL.append(", RE.KAITENRT");
				sbSQL.append(", RE.DAISU");
				sbSQL.append(", RE.KENTIKU");
	...
	public String createSqlTenant(JSONArray dataArray, HashMap<String, String> map, User userInfo){
		...
		for (int i = 0; i < len; i++) {
			...
			if(!values.isEmpty() ){
				sbSQL = new StringBuffer();
				sbSQL.append("merge into INAMS.MSTTENTENANT as T using (select");
				...
				sbSQL.append(") values (");
				sbSQL.append("  RE.TENCD");
				sbSQL.append(", RE.TENANTKB");
				sbSQL.append(", RE.TENANTKN");
				sbSQL.append(", RE.SENDFLG");
				sbSQL.append(", RE.UPDKBN");
				sbSQL.append(", RE.OPERATOR");
				sbSQL.append(", RE.ADDDT");
	...
	public String createSqlSyakusu(JSONArray dataArray, HashMap<String, String> map, User userInfo){
		...
		for (int i = 0; i < len; i++) {
			...
			if(!values.isEmpty() ){
				sbSQL = new StringBuffer();
				sbSQL.append("merge into INAMS.MSTTENBMNSK as T using (select");
				sbSQL.append("  TENCD");																		// 店コード
				...
				sbSQL.append(", BMNCD");
				sbSQL.append(", SYAKU");
				sbSQL.append("))as RE on (T.TENCD = RE.TENCD and T.BMNCD = RE.BMNCD)");
				sbSQL.append(" when matched then update set");
				sbSQL.append("  TENCD = RE.TENCD");
				sbSQL.append(", BMNCD = RE.BMNCD");
				sbSQL.append(", SYAKU = RE.SYAKU");
				sbSQL.append(", SENDFLG = RE.SENDFLG");
				sbSQL.append(", UPDKBN = RE.UPDKBN");
				sbSQL.append(", OPERATOR = RE.OPERATOR");
				sbSQL.append(", UPDDT = RE.UPDDT");
	...
	public JSONArray check(HashMap<String, String> map) {
		...
		if(DefineReport.Button.NEW.getObj().equals(sendBtnid)){
			// 重複チェック：店コード
			sbSQL = new StringBuffer();
			sbSQL.append("select * from INAMS.MSTTEN TEN where TEN.TENCD = "+data.optString("F1")+" and NVL(TEN.UPDKBN, 0) = 0");
