...
public class ReportST011Dao extends ItemDao {
	...
	private String createCommand() {
		...
		if (StringUtils.equals("1", szJissekibun)) {
			...
			sbSQL.append(" ) order by DAICD, CHUCD");
			...
			sbSQL.append(" T1.DAICD");
			sbSQL.append(", T1.CHUCD");
			sbSQL.append(", (select T2.DAIBRUIKN from INAMS.MSTDAIBRUI T2 where T2.BMNCD= ? and T2.DAICD=T1.DAICD)");
			paramData.add(szBmncd);
			sbSQL.append(", T1.TENTEN_ARR");
			sbSQL.append(" from INATK.TOKJRTPTN T1");
			sbSQL.append(" where T1.BMNCD= ? ");
			...
			sbSQL.append(" T1.DAICD");
			sbSQL.append(", T1.CHUCD");
			sbSQL.append(", (select T2.CHUBRUIKN from INAMS.MSTCHUBRUI T2 where T2.BMNCD= ? and T2.DAICD= ? and T2.CHUCD=T1.CHUCD)");
			paramData.add(szBmncd);
