...
public class ReportSO006Dao extends ItemDao {
  ...
  private String createCommand() {
    ...
    sbSQL.append(", DATE_FORMAT(CSVH.INPUT_DATE, '%y/%m/%d')"); // F2 : 処理日
    sbSQL.append(", DATE_FORMAT(CSVH.INPUT_DATE, '%H:%i') as HDN_UPDDT"); // F3 : 時刻
    ...
    sbSQL.append(" where COALESCE(CSO.UPDKBN, 0) <> 1 group by CSO.SEQ) CSVS on CSVS.SEQ = CSVH.SEQ ");
