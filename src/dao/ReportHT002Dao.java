...
public class ReportHT002Dao extends ItemDao {
	...
	private String createCommand() {
		...
		sbSQL.append(",TO_CHAR(SN.UPDDT,'YYYYMMDDHH24MISSNNNNNN') as HDN_UPDDT2 ");	// F15	: 更新日時（正規定量商品）
		...
		sbSQL.append(", ROW_NUMBER() OVER(ORDER BY TN.SHNCD, TN.BINKBN, TO_CHAR(TN.UPDDT, 'YYYYMMDDHH24MISSNNNNNN')) ");												// F23	: 行番号
		sbSQL.append("FROM ");
