...
public class Reportx216Dao extends ItemDao {
  ...
  public JSONArray check(HashMap<String, String> map, User userInfo, String sysdate) {
     ...
     * if(StringUtils.isNotEmpty(val)){ tenBmncds.add(dataArrayG.optJSONObject(i)); tenBmncds_.add(val);
     * } }
     *
     * if(tenBmncds.size() != tenBmncds_.size()){ msg.add(mu.getDbMessageObj("EX1023", new String[]{}));
     * return msg; }
     */
