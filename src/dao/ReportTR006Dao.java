		...
		try {
			...
			if(errMsgList.size()==0){
				...
				msgList = dao.checkData(
						mu,
						this.selectHATSTR(astr,true),	// 正規
...
//		}
	...
	/*private JSONObject createCommandUpdateData(
			ReportTR005Dao dao, User userInfo,
			JSONArray dataArray,	// 正規
		...
		// パラメータ確認
		JSONObject result = dao.createSqlHatstrCsv(dataArray, dataArrayJ, userInfo);

		return option;
	}*/
	private JSONObject createCommandUpdateData(
			ReportTR007Dao dao, User userInfo,
	...
	public enum FileLayout {
		/** 更新区分 */
		TENCD(1,"店舗",RefTable.HATSTR,"TENCD"),
		SHNCD(2,"商品コード",RefTable.HATSTR,"SHNCD"),
		SHNAN(3,"商品名（ｶﾅ）",RefTable.OTHER,"SHNAN"),
		JISEIKBN(4,"次正区分",RefTable.HATSTR,"JISEIKBN"),
		SURYO_MON(5,"数量_月",RefTable.HATSTR,"SURYO_MON"),
		SURYO_TUE(6,"数量_火",RefTable.HATSTR,"SURYO_TUE"),
		SURYO_WED(7,"数量_水",RefTable.HATSTR,"SURYO_WED"),
		SURYO_THU(8,"数量_木",RefTable.HATSTR,"SURYO_THU"),
		SURYO_FRI(9,"数量_金",RefTable.HATSTR,"SURYO_FRI"),
		SURYO_SAT(10,"数量_土",RefTable.HATSTR,"SURYO_SAT"),
		SURYO_SUN(11,"数量_日",RefTable.HATSTR,"SURYO_SUN"),
		SHUNO(12,"週No.",RefTable.HATSTR,"SHUNO"),
		OPERATOR(13,"オペレータ",RefTable.OTHER,"OPERATOR"),
		ADDDT(14,"登録日",RefTable.OTHER,"ADDDT"),
		UPDDT(15,"更新日",RefTable.OTHER,"UPDDT");
