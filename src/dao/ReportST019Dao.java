...
public class ReportST019Dao extends ItemDao {
	...
	private String createCommand() {
		...
		sbSQL.append("   ||'～'||");
		sbSQL.append("   to_char(to_date(T1.NNEDDT, 'YYYYMMDD'), 'YY/MM/DD')||(select JWEEK from WEEK where CWEEK = DAYOFWEEK(TO_DATE(T1.NNEDDT, 'YYYYMMDD'))) as F7");
		...
		sbSQL.append("  ,T1.BMNCD");
		sbSQL.append("  ,T1.KANRINO");
		sbSQL.append(" fetch first 1000 rows only");
