 ...
 *
 */
public class ReportBM013Dao extends ItemDao {
   ...
   * @param source
   */
  public ReportBM013Dao(String JNDIname) {
    super(JNDIname);
  }
  ...
  private String createCommand() {
    ...
    sbSQL.append(" from INATK.CSVTOKHEAD T1");
    sbSQL.append(" WHERE EXISTS(SELECT 1 FROM INATK.CSVTOK_BM T2 WHERE T1.SEQ=T2.SEQ)");
    sbSQL.append(" order by ");
    sbSQL.append("  T1.INPUT_DATE, T1.OPERATOR ");
