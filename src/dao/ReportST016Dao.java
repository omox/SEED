...
public class ReportST016Dao extends ItemDao {
  ...
  private String createCommandForDl() {
    ...
    if (StringUtils.equals(btnId, DefineReport.Button.CSV.getObj() + "1")) {
      ...
      sbSQL.append(
          " inner join CAL on CAL.MOYSKBN = T1.MOYSKBN and CAL.MOYSSTDT = T1.MOYSSTDT and CAL.MOYSRBAN = T1.MOYSRBAN and CAL.BMNCD = T1.BMNCD and CAL.KANRINO = T1.KANRINO and CAL.KANRIENO = T1.KANRIENO");
      ...
      sbSQL.append(", LPAD(COALESCE(CAST(T4.SHNCD AS CHAR), ''), 8, '0') as 商品コード"); // F14 : 商品コード
      ...
      sbSQL.append(
          ", case when CAST(T4.MYOSNNSTDT AS signed) between case when DF.DBMNATRKBN = 1 then T1.NNSTDT_TGF else T1.NNSTDT end and case when DF.DBMNATRKBN = 1 then T1.NNEDDT_TGF else T1.NNEDDT end then T4.MYOSNNSTDT else null end as 催し日付1"); // F86
                                                                                                                                                                                                                                                  // :
                                                                                                                                                                                                                                                  // 催し日付1
      sbSQL.append(
          ", case when CAST(CAL.DT2 AS signed) between case when DF.DBMNATRKBN = 1 then T1.NNSTDT_TGF else T1.NNSTDT end and case when DF.DBMNATRKBN = 1 then T1.NNEDDT_TGF else T1.NNEDDT end then CAL.DT2 else null end as 催し日付2"); // F87
                                                                                                                                                                                                                                      // :
                                                                                                                                                                                                                                      // 催し日付2
      sbSQL.append(
          ", case when CAST(CAL.DT3 AS signed) between case when DF.DBMNATRKBN = 1 then T1.NNSTDT_TGF else T1.NNSTDT end and case when DF.DBMNATRKBN = 1 then T1.NNEDDT_TGF else T1.NNEDDT end then CAL.DT3 else null end as 催し日付3"); // F88
                                                                                                                                                                                                                                      // :
                                                                                                                                                                                                                                      // 催し日付3
      sbSQL.append(
          ", case when CAST(CAL.DT4 AS signed) between case when DF.DBMNATRKBN = 1 then T1.NNSTDT_TGF else T1.NNSTDT end and case when DF.DBMNATRKBN = 1 then T1.NNEDDT_TGF else T1.NNEDDT end then CAL.DT4 else null end as 催し日付4"); // F89
                                                                                                                                                                                                                                      // :
                                                                                                                                                                                                                                      // 催し日付4
      sbSQL.append(
          ", case when CAST(CAL.DT5 AS signed) between case when DF.DBMNATRKBN = 1 then T1.NNSTDT_TGF else T1.NNSTDT end and case when DF.DBMNATRKBN = 1 then T1.NNEDDT_TGF else T1.NNEDDT end then CAL.DT5 else null end as 催し日付5"); // F90
                                                                                                                                                                                                                                      // :
                                                                                                                                                                                                                                      // 催し日付5
      sbSQL.append(
          ", case when CAST(CAL.DT6 AS signed) between case when DF.DBMNATRKBN = 1 then T1.NNSTDT_TGF else T1.NNSTDT end and case when DF.DBMNATRKBN = 1 then T1.NNEDDT_TGF else T1.NNEDDT end then CAL.DT6 else null end as 催し日付6"); // F91
                                                                                                                                                                                                                                      // :
                                                                                                                                                                                                                                      // 催し日付6
      sbSQL.append(
          ", case when CAST(CAL.DT7 AS signed) between case when DF.DBMNATRKBN = 1 then T1.NNSTDT_TGF else T1.NNSTDT end and case when DF.DBMNATRKBN = 1 then T1.NNEDDT_TGF else T1.NNEDDT end then CAL.DT7 else null end as 催し日付7"); // F92
                                                                                                                                                                                                                                      // :
                                                                                                                                                                                                                                      // 催し日付7
      sbSQL.append(
          ", case when CAST(CAL.DT8 AS signed) between case when DF.DBMNATRKBN = 1 then T1.NNSTDT_TGF else T1.NNSTDT end and case when DF.DBMNATRKBN = 1 then T1.NNEDDT_TGF else T1.NNEDDT end then CAL.DT8 else null end as 催し日付8"); // F93
                                                                                                                                                                                                                                      // :
                                                                                                                                                                                                                                      // 催し日付8
      sbSQL.append(
          ", case when CAST(CAL.DT9 AS signed) between case when DF.DBMNATRKBN = 1 then T1.NNSTDT_TGF else T1.NNSTDT end and case when DF.DBMNATRKBN = 1 then T1.NNEDDT_TGF else T1.NNEDDT end then CAL.DT9 else null end as 催し日付9"); // F94
                                                                                                                                                                                                                                      // :
                                                                                                                                                                                                                                      // 催し日付9
      sbSQL.append(
          ", case when CAST(CAL.DT10 AS signed) between case when DF.DBMNATRKBN = 1 then T1.NNSTDT_TGF else T1.NNSTDT end and case when DF.DBMNATRKBN = 1 then T1.NNEDDT_TGF else T1.NNEDDT end then CAL.DT10 else null end as 催し日付10"); // F95
                                                                                                                                                                                                                                         // :
                                                                                                                                                                                                                                         // 催し日付10
      sbSQL.append(", case when CAST(T4.MYOSNNSTDT AS signed) between T4.HBSTDT and T4.HBEDDT then 1 else null end as 販売対象1"); // F96 : 販売対象1
      sbSQL.append(", case when CAST(CAL.DT2 AS signed) between T4.HBSTDT and T4.HBEDDT then 1 else null end as 販売対象2"); // F97 : 販売対象2
      sbSQL.append(", case when CAST(CAL.DT3 AS signed) between T4.HBSTDT and T4.HBEDDT then 1 else null end as 販売対象3"); // F98 : 販売対象3
      sbSQL.append(", case when CAST(CAL.DT4 AS signed) between T4.HBSTDT and T4.HBEDDT then 1 else null end as 販売対象4"); // F99 : 販売対象4
      sbSQL.append(", case when CAST(CAL.DT5 AS signed) between T4.HBSTDT and T4.HBEDDT then 1 else null end as 販売対象5"); // F100 : 販売対象5
      sbSQL.append(", case when CAST(CAL.DT6 AS signed) between T4.HBSTDT and T4.HBEDDT then 1 else null end as 販売対象6"); // F101 : 販売対象6
      sbSQL.append(", case when CAST(CAL.DT7 AS signed) between T4.HBSTDT and T4.HBEDDT then 1 else null end as 販売対象7"); // F102 : 販売対象7
      sbSQL.append(", case when CAST(CAL.DT8 AS signed) between T4.HBSTDT and T4.HBEDDT then 1 else null end as 販売対象8"); // F103 : 販売対象8
      sbSQL.append(", case when CAST(CAL.DT9 AS signed) between T4.HBSTDT and T4.HBEDDT then 1 else null end as 販売対象9"); // F104 : 販売対象9
      sbSQL.append(", case when CAST(CAL.DT10 AS signed) between T4.HBSTDT and T4.HBEDDT then 1 else null end as 販売対象10"); // F105 : 販売対象10
      ...
      sbSQL.append(", case when T4.TENKAIKBN = '2' then null when CAL2.NDT1 is not null or CAST(T4.NNSTDT AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.HTS1 end as 発注総数1"); // F116 : 発注総数1
      sbSQL.append(", case when T4.TENKAIKBN = '2' then null when CAL2.NDT2 is not null or CAST(CAL.DT2 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.HTS2 end as 発注総数2"); // F117 : 発注総数2
      sbSQL.append(", case when T4.TENKAIKBN = '2' then null when CAL2.NDT3 is not null or CAST(CAL.DT3 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.HTS3 end as 発注総数3"); // F118 : 発注総数3
      sbSQL.append(", case when T4.TENKAIKBN = '2' then null when CAL2.NDT4 is not null or CAST(CAL.DT4 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.HTS4 end as 発注総数4"); // F119 : 発注総数4
      sbSQL.append(", case when T4.TENKAIKBN = '2' then null when CAL2.NDT5 is not null or CAST(CAL.DT5 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.HTS5 end as 発注総数5"); // F120 : 発注総数5
      sbSQL.append(", case when T4.TENKAIKBN = '2' then null when CAL2.NDT6 is not null or CAST(CAL.DT6 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.HTS6 end as 発注総数6"); // F121 : 発注総数6
      sbSQL.append(", case when T4.TENKAIKBN = '2' then null when CAL2.NDT7 is not null or CAST(CAL.DT7 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.HTS7 end as 発注総数7"); // F122 : 発注総数7
      sbSQL.append(", case when T4.TENKAIKBN = '2' then null when CAL2.NDT8 is not null or CAST(CAL.DT8 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.HTS8 end as 発注総数8"); // F123 : 発注総数8
      sbSQL.append(", case when T4.TENKAIKBN = '2' then null when CAL2.NDT9 is not null or CAST(CAL.DT9 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.HTS9 end as 発注総数9"); // F124 : 発注総数9
      sbSQL.append(", case when T4.TENKAIKBN = '2' then null when CAL2.NDT10 is not null or CAST(CAL.DT10 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.HTS10 end as 発注総数10"); // F125 : 発注総数10
      sbSQL.append(", case when CAL2.NDT1 is not null or CAST(T4.NNSTDT AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.PTN1 end as パタン№1"); // F126 : パタン№1
      sbSQL.append(", case when CAL2.NDT2 is not null or CAST(CAL.DT2 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.PTN2 end as パタン№2"); // F127 : パタン№2
      sbSQL.append(", case when CAL2.NDT3 is not null or CAST(CAL.DT3 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.PTN3 end as パタン№3"); // F128 : パタン№3
      sbSQL.append(", case when CAL2.NDT4 is not null or CAST(CAL.DT4 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.PTN4 end as パタン№4"); // F129 : パタン№4
      sbSQL.append(", case when CAL2.NDT5 is not null or CAST(CAL.DT5 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.PTN5 end as パタン№5"); // F130 : パタン№5
      sbSQL.append(", case when CAL2.NDT6 is not null or CAST(CAL.DT6 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.PTN6 end as パタン№6"); // F131 : パタン№6
      sbSQL.append(", case when CAL2.NDT7 is not null or CAST(CAL.DT7 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.PTN7 end as パタン№7"); // F132 : パタン№7
      sbSQL.append(", case when CAL2.NDT8 is not null or CAST(CAL.DT8 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.PTN8 end as パタン№8"); // F133 : パタン№8
      sbSQL.append(", case when CAL2.NDT9 is not null or CAST(CAL.DT9 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.PTN9 end as パタン№9"); // F134 : パタン№9
      sbSQL.append(", case when CAL2.NDT10 is not null or CAST(CAL.DT10 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.PTN10 end as パタン№10"); // F135 : パタン№10
      sbSQL.append(", case when CAL2.NDT1 is not null or CAST(T4.NNSTDT AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.TSK1 end as 訂正区分1"); // F136 : 訂正区分1
      sbSQL.append(", case when CAL2.NDT2 is not null or CAST(CAL.DT2 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.TSK2 end as 訂正区分2"); // F137 : 訂正区分2
      sbSQL.append(", case when CAL2.NDT3 is not null or CAST(CAL.DT3 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.TSK3 end as 訂正区分3"); // F138 : 訂正区分3
      sbSQL.append(", case when CAL2.NDT4 is not null or CAST(CAL.DT4 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.TSK4 end as 訂正区分4"); // F139 : 訂正区分4
      sbSQL.append(", case when CAL2.NDT5 is not null or CAST(CAL.DT5 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.TSK5 end as 訂正区分5"); // F140 : 訂正区分5
      sbSQL.append(", case when CAL2.NDT6 is not null or CAST(CAL.DT6 AS signed) between T4.HBSTDT and T4.HBEDDT then CAL2.TSK6 end as 訂正区分6"); // F141 : 訂正区分6
      ...
      sbSQL.append(", WK.ADT1 as 追加店1, WK.ADT2 as 追加店2, WK.ADT3 as 追加店3, WK.ADT4 as 追加店4, WK.ADT5 as 追加店5, WK.ADT6 as 追加店6, WK.ADT7 as 追加店7, WK.ADT8 as 追加店8, WK.ADT9 as 追加店9, WK.ADT10 as 追加店10"); // F146~F155
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    // 追加店1~10
      sbSQL.append(
          ", WK.RNK1 as 追加店ランク1, WK.RNK2 as 追加店ランク2, WK.RNK3 as 追加店ランク3, WK.RNK4 as 追加店ランク4, WK.RNK5 as 追加店ランク5, WK.RNK6 as 追加店ランク6, WK.RNK7 as 追加店ランク7, WK.RNK8 as 追加店ランク8, WK.RNK9 as 追加店ランク9, WK.RNK10 as 追加店ランク10"); // F156~F165
                                                                                                                                                                                                                         // :
                                                                                                                                                                                                                         // 追加店ランク1~10
      sbSQL.append(", WK.DLT1 as 除外店1, WK.DLT2 as 除外店2, WK.DLT3 as 除外店3, WK.DLT4 as 除外店4, WK.DLT5 as 除外店5, WK.DLT6 as 除外店6, WK.DLT7 as 除外店7, WK.DLT8 as 除外店8, WK.DLT9 as 除外店9, WK.DLT10 as 除外店10"); // F166~F175
                                                                                                                                                                                                    // :
                                                                                                                                                                                                    // 除外店1~10
      ...
      sbSQL.append(", DATE_FORMAT(T4.ADDDT, '%Y%m%d') as 登録日"); // F193 : 登録日
      sbSQL.append(", DATE_FORMAT(current_timestamp, '%Y%m%d') as 更新日"); // F194 : 更新日
      ...
      sbSQL.append(" left join INATK.TOKMOYDEF DF on T4.BMNCD = DF.BMNCD and COALESCE(DF.UPDKBN, 0) <> 1");
      ...
      sbSQL.append(", CAST(COALESCE(T5.SURYO, 0) AS signed) as 数量"); // F12 : 数量
      ...
      sbSQL.append(", DATE_FORMAT(T5.ADDDT, '%Y%m%d') AS 登録日"); // F23 : 登録日
      sbSQL.append(", DATE_FORMAT(current_timestamp, '%Y%m%d') AS 更新日"); // F24 : 更新日
      sbSQL.append(" from INATK.TOKMOYCD T1");
      if (isTOKTG) {
      ...
      sbSQL.append(
          " inner join ARRWK T5 on T5.MOYSKBN = T4.MOYSKBN and T5.MOYSSTDT = T4.MOYSSTDT and T5.MOYSRBAN = T4.MOYSRBAN and T5.MOYSRBAN = T4.MOYSRBAN and T5.BMNCD = T4.BMNCD and T5.KANRINO = T4.KANRINO and T5.KANRIENO = T4.KANRIENO and COALESCE(T4.UPDKBN, 0) <> 1");
      sbSQL.append(
          " inner join INAMS.MSTTEN M1 on T5.IDX = M1.TENCD and LENGTH(TRIM(T5.SURYO)) > 0 left join (select * from INAMS.MSTTENBMN where BMNCD = 1) M2 on M2.TENCD = M1.TENCD inner join INAMS.MSTDAIBRUI M3 on M3.BMNCD = T4.BMNCD and M3.DAICD = T4.DAICD and COALESCE(M3.UPDKBN, 0) <> 1");
      sbSQL.append(" left outer join INAMS.MSTCHUBRUI M4 on M4.BMNCD = T4.BMNCD and M4.DAICD = T4.DAICD and M4.CHUCD = T4.CHUCD and COALESCE(M4.UPDKBN, 0) <> 1");
      sbSQL.append(" inner join INAMS.MSTSHN M5 on M5.SHNCD = T4.SHNCD and COALESCE(M5.UPDKBN, 0) <> 1");
      sbSQL.append(" left outer join INAMS.MSTSHOBRUI M6 on M6.BMNCD = T4.BMNCD and M6.DAICD = T4.DAICD and M6.CHUCD = T4.CHUCD and M6.SHOCD = M5.SHOCD and COALESCE(M6.UPDKBN, 0) <> 1 ");
