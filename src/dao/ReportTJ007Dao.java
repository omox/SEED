...
public class ReportTJ007Dao extends ItemDao {
  ...
  private String createCommand() {
    ...
    HashMap<String, String> avgptankaMap = new HashMap<>();
    ...
    HashMap<String, BigDecimal> yoteisu = new HashMap<>();
    HashMap<String, BigDecimal> baikakei = new HashMap<>();
    HashMap<String, BigDecimal> genkakei = new HashMap<>();
    ...
    for (int i = 0; i < wkArray.size(); i++) {
      ...
      if (getNhKetaiKbn.equals("1")) {
        ...
        baikakei = new HashMap<>();
        genkakei = new HashMap<>();
      }
    }
    ...
    sbSQL.append(" as T1(F1 ,F2 ,F3 ,F4 ,F5 ,F6 ,F7 ,F8 ,F9 ,F10 ,F11 ,F12 ,F13 ,F14 ,F15, F16 ,F17, F18) ");
  ...
  public JSONArray getTOKTJSHNDTWKData(HashMap<String, String> map) {
    ...
    sbSQL.append(" , COALESCE(T1.JRYO,0) JRYO ");
    ...
    sbSQL.append("(SELECT BMNCD,DAICD,DAIBRUIKN,ROW_NUMBER() OVER (ORDER BY DAICD) AS ROWNUM FROM INAMS.MSTDAIBRUI WHERE BMNCD=? AND UPDKBN=" + DefineReport.ValUpdkbn.NML.getVal() + ")T1");
    sbSQL.append(" WHERE ROWNUM BETWEEN ? AND ?)");
    sbSQL.append(" SELECT T0.DAICD,COALESCE(T1.NHKETAIKBN,'1') AS NHKETAIKBN ");
    ...
    sbSQL.append(" ,COALESCE(SUM(T1.HTSU_01*T1.IRISU_TB* CASE WHEN T1.NHKETAIKBN = '2' THEN T1.JRYO ELSE 1 END),'0') AS HTSU_01");
    sbSQL.append(" ,COALESCE(SUM(T1.HTSU_02*T1.IRISU_TB* CASE WHEN T1.NHKETAIKBN = '2' THEN T1.JRYO ELSE 1 END),'0') AS HTSU_02");
    sbSQL.append(" ,COALESCE(SUM(T1.HTSU_03*T1.IRISU_TB* CASE WHEN T1.NHKETAIKBN = '2' THEN T1.JRYO ELSE 1 END),'0') AS HTSU_03");
    sbSQL.append(" ,COALESCE(SUM(T1.HTSU_04*T1.IRISU_TB* CASE WHEN T1.NHKETAIKBN = '2' THEN T1.JRYO ELSE 1 END),'0') AS HTSU_04");
    sbSQL.append(" ,COALESCE(SUM(T1.HTSU_05*T1.IRISU_TB* CASE WHEN T1.NHKETAIKBN = '2' THEN T1.JRYO ELSE 1 END),'0') AS HTSU_05");
    sbSQL.append(" ,COALESCE(SUM(T1.HTSU_06*T1.IRISU_TB* CASE WHEN T1.NHKETAIKBN = '2' THEN T1.JRYO ELSE 1 END),'0') AS HTSU_06");
    sbSQL.append(" ,COALESCE(SUM(T1.HTSU_07*T1.IRISU_TB* CASE WHEN T1.NHKETAIKBN = '2' THEN T1.JRYO ELSE 1 END),'0') AS HTSU_07");
    sbSQL.append(" ,COALESCE(SUM(T1.HTSU_08*T1.IRISU_TB* CASE WHEN T1.NHKETAIKBN = '2' THEN T1.JRYO ELSE 1 END),'0') AS HTSU_08");
    sbSQL.append(" ,COALESCE(SUM(T1.HTSU_09*T1.IRISU_TB* CASE WHEN T1.NHKETAIKBN = '2' THEN T1.JRYO ELSE 1 END),'0') AS HTSU_09");
    sbSQL.append(" ,COALESCE(SUM(T1.HTSU_10*T1.IRISU_TB* CASE WHEN T1.NHKETAIKBN = '2' THEN T1.JRYO ELSE 1 END),'0') AS HTSU_10");
    sbSQL.append(" ,COALESCE(SUM((T1.BAIKAAM_TB*T1.HTSU_01*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS NNBAIKA_01");
    sbSQL.append(" ,COALESCE(SUM((T1.BAIKAAM_TB*T1.HTSU_02*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS NNBAIKA_02");
    sbSQL.append(" ,COALESCE(SUM((T1.BAIKAAM_TB*T1.HTSU_03*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS NNBAIKA_03");
    sbSQL.append(" ,COALESCE(SUM((T1.BAIKAAM_TB*T1.HTSU_04*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS NNBAIKA_04");
    sbSQL.append(" ,COALESCE(SUM((T1.BAIKAAM_TB*T1.HTSU_05*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS NNBAIKA_05");
    sbSQL.append(" ,COALESCE(SUM((T1.BAIKAAM_TB*T1.HTSU_06*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS NNBAIKA_06");
    sbSQL.append(" ,COALESCE(SUM((T1.BAIKAAM_TB*T1.HTSU_07*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS NNBAIKA_07");
    sbSQL.append(" ,COALESCE(SUM((T1.BAIKAAM_TB*T1.HTSU_08*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS NNBAIKA_08");
    sbSQL.append(" ,COALESCE(SUM((T1.BAIKAAM_TB*T1.HTSU_09*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS NNBAIKA_09");
    sbSQL.append(" ,COALESCE(SUM((T1.BAIKAAM_TB*T1.HTSU_10*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS NNBAIKA_10");
    sbSQL.append(" ,COALESCE(SUM((T1.GENKAAM_MAE*T1.HTSU_01*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS GENKAAM_MAE_01");
    sbSQL.append(" ,COALESCE(SUM((T1.GENKAAM_MAE*T1.HTSU_02*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS GENKAAM_MAE_02");
    sbSQL.append(" ,COALESCE(SUM((T1.GENKAAM_MAE*T1.HTSU_03*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS GENKAAM_MAE_03");
    sbSQL.append(" ,COALESCE(SUM((T1.GENKAAM_MAE*T1.HTSU_04*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS GENKAAM_MAE_04");
    sbSQL.append(" ,COALESCE(SUM((T1.GENKAAM_MAE*T1.HTSU_05*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS GENKAAM_MAE_05");
    sbSQL.append(" ,COALESCE(SUM((T1.GENKAAM_MAE*T1.HTSU_06*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS GENKAAM_MAE_06");
    sbSQL.append(" ,COALESCE(SUM((T1.GENKAAM_MAE*T1.HTSU_07*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS GENKAAM_MAE_07");
    sbSQL.append(" ,COALESCE(SUM((T1.GENKAAM_MAE*T1.HTSU_08*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS GENKAAM_MAE_08");
    sbSQL.append(" ,COALESCE(SUM((T1.GENKAAM_MAE*T1.HTSU_09*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS GENKAAM_MAE_09");
    sbSQL.append(" ,COALESCE(SUM((T1.GENKAAM_MAE*T1.HTSU_10*T1.IRISU_TB))/CAST(1000 as float),CAST(0 as float)) AS GENKAAM_MAE_10");
    sbSQL.append(" FROM");
