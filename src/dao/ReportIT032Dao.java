 ...
 *
 */
public class ReportIT032Dao extends ItemDao {
	 ...
	 * @param source
	 */
	public ReportIT032Dao(String JNDIname) {
		super(JNDIname);
	}
...
//		}
	...
	public enum FileLayout {
		/** 店コード */
		TENCD(1,"店コード",RefTable.MSTAHS,"TENCD","SMALLINT"),
		/** 自動発注区分 */
		AHSKB(2,"自動発注区分",RefTable.MSTAHS,"AHSKB","CHARACTER(1)");
