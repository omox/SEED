...
public class JQEasyJSON extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    if (!((DefineReport.ID_PAGE_X241.equals(report) || DefineReport.ID_PAGE_X243.equals(report)) && request.getParameter("rows") != null)) {
      limit = Integer.parseInt(option.getString("rows") == null || ArrayUtils.contains(RowsLengthLimitUtility.defaultValues, option.getInt("rows")) ? "999999" : option.getString("rows"));
    }
