...
public class MessageUtility {
  ...
  public String getDbMessage(String key, String... args) {
    ...
    if (StringUtils.contains(msgObj.optString("MSGTXT1"), "%")) {
      return (msgObj.optString("MSGTXT1").replace(",", "。") + msgObj.optString("MSGTXT2")).replace("%1", add1).replace("%2", add2).replace("%3", add3);
    } else {
      return (add1 + msgObj.optString("MSGTXT1").replace(",", "。") + add2 + msgObj.optString("MSGTXT2") + add3);// .replace("/^\s+|\s+$/g","");
    }
  }
   ...
   * @param addParam メッセージに付加するパラメータ
   * @return DBエラーメッセージ情報
   */
   ...
   */
  public static JSONObject getCheckMaxLengthMessage(DefineReport.InpText field, FieldType fieldType, String... addParam) {
    String messageId = "";
    String[] param = null;
   ...
   */
  public static JSONObject getCheckZeroOrPlusIntegerMessage(DefineReport.InpText field, FieldType fieldType, String... addParam) {
  ...
  public static String HanToZenForAlpha(String p) {
    ...
    for (int i = 0; i < p.length(); i++) {
      ...
      if (c.compareTo(new Character((char) 0x0021)) >= 0 && c.compareTo(new Character((char) 0x007e)) <= 0) {
  ...
  private static final String kanaHanZenTbl[][] = {
      ...
      {"ｶﾞ", "ガ"}, {"ｷﾞ", "ギ"}, {"ｸﾞ", "グ"}, {"ｹﾞ", "ゲ"}, {"ｺﾞ", "ゴ"}, {"ｻﾞ", "ザ"}, {"ｼﾞ", "ジ"}, {"ｽﾞ", "ズ"}, {"ｾﾞ", "ゼ"}, {"ｿﾞ", "ゾ"}, {"ﾀﾞ", "ダ"}, {"ﾁﾞ", "ヂ"}, {"ﾂﾞ", "ヅ"}, {"ﾃﾞ", "デ"}, {"ﾄﾞ", "ド"},
      {"ﾊﾞ", "バ"}, {"ﾋﾞ", "ビ"}, {"ﾌﾞ", "ブ"}, {"ﾍﾞ", "ベ"}, {"ﾎﾞ", "ボ"}, {"ﾊﾟ", "パ"}, {"ﾋﾟ", "ピ"}, {"ﾌﾟ", "プ"}, {"ﾍﾟ", "ペ"}, {"ﾎﾟ", "ポ"}, {"ｳﾞ", "ヴ"},
      // 1文字構成の半角カナ
      {"ｱ", "ア"}, {"ｲ", "イ"}, {"ｳ", "ウ"}, {"ｴ", "エ"}, {"ｵ", "オ"}, {"ｶ", "カ"}, {"ｷ", "キ"}, {"ｸ", "ク"}, {"ｹ", "ケ"}, {"ｺ", "コ"}, {"ｻ", "サ"}, {"ｼ", "シ"}, {"ｽ", "ス"}, {"ｾ", "セ"}, {"ｿ", "ソ"}, {"ﾀ", "タ"},
      {"ﾁ", "チ"}, {"ﾂ", "ツ"}, {"ﾃ", "テ"}, {"ﾄ", "ト"}, {"ﾅ", "ナ"}, {"ﾆ", "ニ"}, {"ﾇ", "ヌ"}, {"ﾈ", "ネ"}, {"ﾉ", "ノ"}, {"ﾊ", "ハ"}, {"ﾋ", "ヒ"}, {"ﾌ", "フ"}, {"ﾍ", "ヘ"}, {"ﾎ", "ホ"}, {"ﾏ", "マ"}, {"ﾐ", "ミ"},
      {"ﾑ", "ム"}, {"ﾒ", "メ"}, {"ﾓ", "モ"}, {"ﾔ", "ヤ"}, {"ﾕ", "ユ"}, {"ﾖ", "ヨ"}, {"ﾗ", "ラ"}, {"ﾘ", "リ"}, {"ﾙ", "ル"}, {"ﾚ", "レ"}, {"ﾛ", "ロ"}, {"ﾜ", "ワ"}, {"ｲ", "ヰ"}, {"ｴ", "ヱ"}, {"ｦ", "ヲ"}, {"ﾝ", "ン"},
  ...
  public static String HanToZenForKana(String p) {
    ...
    for (int i = 0, j = 0; i < p.length(); i++) {
      ...
      if (c.compareTo(new Character((char) 0xff61)) >= 0 && c.compareTo(new Character((char) 0xff9f)) <= 0) {
        // 半角全角変換テーブルを検索する
