...
public class TenpoList {
	 ...
	 * @throws Exception
	 */
	public boolean setTenpoGroup(JSONArray json, String jdbcName) throws Exception {
		...
		try {
			...
			// T_CTG_HEADの登録
			sqlCommand = DefineReport.ID_SQL_KEY_SET_HEAD_TG;
			...
			// T_CTG_ITEMの削除
			sqlCommand = DefineReport.ID_SQL_KEY_DELETE_ITEM_TG;
			...
			// T_CTG_ITEMの登録
			sqlCommand = DefineReport.ID_SQL_KEY_SET_ITEM_TG;
	...
	public boolean deleteItemQuery(JSONArray json, String jdbcName) throws Exception {
		...
		try {
			...
			// T_CTG_ITEMの削除
			sqlCommand = DefineReport.ID_SQL_KEY_DELETE_ITEM_SP_TG;
			...
			// T_CTG_HEADの削除
			sqlCommand = DefineReport.ID_SQL_KEY_DELETE_HEAD_SP_TG;
