...
public class DefineReport {
  ...
  public final static String ID_SQL_RANKSURYO_NEW =
      "select 'A' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all  select 'B' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'C' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'D' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'E' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'F' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'G' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'H' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'I' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'J' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'K' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'L' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'M' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'N' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'O' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'P' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'Q' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'R' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'S' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'T' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'U' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'V' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'W' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'X' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'Y' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'Z' as TENRANK , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY order by TENRANK";
  public final static String ID_SQL_RANKSURYO_CHANGE =
      "select SRYRANK.TENRANK as TENRANK, SRYRANK.SURYO as SURYO from INATK.TOKSRYRANK SRYRANK where SRYRANK.BMNCD = ? and SRYRANK.SRYPTNNO = ? order by SRYRANK.TENRANK";
  public final static String ID_SQL_RANKSURYO_CHANGE_EX =
      "select SRYRANKEX.TENRANK as TENRANK, SRYRANKEX.SURYO from INATK.TOKSRYRANKEX SRYRANKEX where SRYRANKEX.BMNCD = ? and SRYRANKEX.SRYPTNNO = ? and SRYRANKEX.MOYSKBN = ? and SRYRANKEX.MOYSSTDT = ? and SRYRANKEX.MOYSRBAN = ? order by SRYRANKEX.TENRANK";
