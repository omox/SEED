...
public class DefineReport {
  ...
  public final static String ID_SQL_RANKSURYO_NEW =
      "select 'A' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all  select 'B' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'C' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'D' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'E' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'F' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'G' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'H' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'I' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'J' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'K' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'L' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'M' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'N' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'O' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'P' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'Q' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'R' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'S' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'T' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'U' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'V' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'W' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'X' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'Y' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY union all select 'Z' as RANK1 , 0 as SURYO from (SELECT 1 AS DUMMY) DUMMY order by RANK1";
  public final static String ID_SQL_RANKSURYO_CHANGE =
      "select SRYRANK.TENRANK as RANK1, SRYRANK.SURYO as SURYO from INATK.TOKSRYRANK SRYRANK where SRYRANK.BMNCD = ? and SRYRANK.SRYPTNNO = ? order by SRYRANK.TENRANK";
  public final static String ID_SQL_RANKSURYO_CHANGE_EX =
      "select SRYRANKEX.TENRANK as RANK1, SRYRANKEX.SURYO from INATK.TOKSRYRANKEX SRYRANKEX where SRYRANKEX.BMNCD = ? and SRYRANKEX.SRYPTNNO = ? and SRYRANKEX.MOYSKBN = ? and SRYRANKEX.MOYSSTDT = ? and SRYRANKEX.MOYSRBAN = ? order by SRYRANKEX.TENRANK";
