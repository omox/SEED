...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<div  id = "searchCombo" style="padding:10px 25px 0;">
		<select class="easyui-combobox"  id="<%=DefineReport.Select.BUMON.getObj()%>" style="width:240px;" tabindex="51" data-options="label:'部門',labelWidth:40,panelHeight:200,required:true"></select>
		<a href="#" title="検索" id="<%=DefineReport.Button.SEARCH.getObj()%>" class="easyui-linkbutton"  tabindex="52" iconCls="icon-search"><span class="btnTxt">検索</span></a>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.SA004.js?v=<%=prm %>"></script>
