...
<div id="search" data-options="region:'north',border:false" style="display:none;height:250px;padding:20px 8px 0;text-align:center;" >
	...
	<tr>
	<td></td>
	<td class="lbl_box" colspan="3"><input class="easyui-textbox" tabindex="-1" id="<%=DefineReport.Text.STATUS.getObj()%>" readonly="readonly" data-options="label:'ステータス',labelWidth:70,readonly:true,editable:false" style="width:520px;text-align:center;"></td>
	</tr>
	<tr>
	<td colspan="2"></td>
	...
	<tr>
	<td colspan="2"></td>
	<td><input class="easyui-textbox" tabindex="1" id="<%=DefineReport.InpText.COMMENTKN.getObj()%>" check='"datatyp":"zen_text","maxlen":40' data-options="label:'コメント',labelWidth:70,required:true" style="width:320px;"></td>
	</tr>
	<tr>
	<td></td>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.SO004.js?v=<%=prm %>"></script>
