	...
	<tr>
		...
		<td style="height:50px;">
			<fieldset style="width:80px;margin-left: 50px;">
				<legend>PCサイズ</legend>
				<div class="inp_box">
					<label class="rad_lbl"><input type="radio" col="F3" tabindex="2" name="<%=DefineReport.Radio.PCARDSZ1.getObj()%>" value="1" style="vertical-align:middle;" checked="checked"/>大</label>
					<label class="rad_lbl"><input type="radio" col="F3" tabindex="3" name="<%=DefineReport.Radio.PCARDSZ1.getObj()%>" value="2" style="vertical-align:middle;"/>小</label>
				</div>
			</fieldset>
		</td>
	</tr>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 20px;">
	<div class="btn" style="float: left;">
		...
		<td><a href="#" title="登録" class="easyui-linkbutton" tabindex="7" id="<%=DefineReport.Button.UPD.getObj()%>" title="<%=DefineReport.Button.UPD.getTxt()%>" iconCls="icon-save" style="width:110px;"><span class="btnTxt"><%=DefineReport.Button.UPD.getTxt()%></span></a></td>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x213.js?v=<%=prm %>"></script>
