...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<tr>
		<td>
			...
			<tr>
				<td class="col_txt" style="height: 20px;"><input class="easyui-numberbox" tabindex="1" id="<%=DefineReport.InpText.BMNCD.getObj()%>" check='<%=DefineReport.InpText.BMNCD.getMaxlenTag()%>' data-options="required:true" style="height:20px;width:40px;text-align:left;" value=""></td>
			</tr>
			</table>
		</td>
		<td>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td><a href="#" title="新規" id="<%=DefineReport.Button.NEW.getObj()%>" class="easyui-linkbutton" tabindex="902" iconCls="icon-add" style="width:125px;"><span class="btnTxt">新規</span></a></td>
		<td><a href="#" title="選択(変更)" id="<%=DefineReport.Button.SEL_CHANGE.getObj()%>" class="easyui-linkbutton" tabindex="903" iconCls="icon-ok" style="width:125px;"><span>選択(変更)</span></a></td>
		<td><a href="#" title="選択(参照)" id="<%=DefineReport.Button.SEL_REFER.getObj()%>" class="easyui-linkbutton" tabindex="904" iconCls="icon-ok" style="width:125px;"><span>選択(参照)</span></a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.RP003.js?v=<%=prm %>"></script>
