...
<div id="search" data-options="region:'north',border:false" style="display:none;height:40px;padding:3px 8px 0;" >
	<div>
	<input class="easyui-combobox" tabindex="1" id="<%=DefineReport.Select.BNNRUIKBN.getObj()%>" data-options="label:'分類区分',labelWidth:75" style="width:130px;">
	...
	<a href="#" title="検索" id="btn_search" class="easyui-linkbutton" tabindex="3" iconCls="icon-search"><span class="btnTxt">検索</span></a>
	</div>
</div>
<script>
...
<div id="list" data-options="region:'center',border:false" style="display:none;">
	...
	<div class="ref_editor" style="display: none;">
	 	...
	 	<input type="checkbox" class="chkbox" tabindex="-1" col="F14" id="chk_f14">
		<input class="easyui-numberbox" tabindex="-1" col="F1"  id='txt_f1'  check='<%=DefineReport.InpText.DAICD.getMaxlenTag()%>'>
		<input class="easyui-textbox" 	tabindex="-1" col="F2"  id="txt_f2"  check='<%=DefineReport.InpText.DAIBRUIAN.getMaxlenTag()%>'>
		<input class="easyui-textbox" 	tabindex="-1" col="F3"  id="txt_f3"  check='<%=DefineReport.InpText.DAIBRUIKN.getMaxlenTag()%>'>
		...
		<input class="easyui-textbox" 	tabindex="-1" col="F10" id='txt_f10'>
		<input class="easyui-textbox" 	tabindex="-1" col="F11" id="txt_f11">
		<input class="easyui-textbox" 	tabindex="-1" col="F12" id="txt_f12">
		<input class="easyui-numberbox" tabindex="-1" col="F13" id="txt_f13">
	</div>
</div>
</form>
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 30px;text-align: center;align: left;">
	<div class="btn" style="text-align: left;">
		...
		<td><a href="#" title="選択" class="easyui-linkbutton" tabindex="8" id="<%=DefineReport.Button.SELECT.getObj()%>" title="<%=DefineReport.Button.SELECT.getTxt()%>" iconCls="icon-remove" style="width:125px;"><%=DefineReport.Button.SELECT.getTxt()%>(中分類へ)</a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x031.js?v=<%=prm %>"></script>
