...
<div id="list" data-options="region:'center',border:false" style="display:none;">
	...
	<div class="ref_editor" style="display: none;">
		<input class="easyui-numberbox" tabindex="-1" col="F1"  id='txt_f1'  check='<%=DefineReport.InpText.CHUCD.getMaxlenTag()%>'/>
		<input class="easyui-textbox" 	tabindex="-1" col="F2"  id="txt_f2"  check='<%=DefineReport.InpText.CHUBRUIAN.getMaxlenTag()%>'data-options="editable:true">
		<input class="easyui-textbox" 	tabindex="-1" col="F3"  id="txt_f3"  check='<%=DefineReport.InpText.CHUBRUIKN.getMaxlenTag()%>'data-options="editable:true">
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 30px;text-align: center;align: left;">
	<div class="btn" style="float: left;">
		...
		<td><a href="#" title="選択" class="easyui-linkbutton" tabindex="8" id="<%=DefineReport.Button.SELECT.getObj()%>" title="<%=DefineReport.Button.SELECT.getTxt()%>" iconCls="icon-remove" style="width:150px;"><%=DefineReport.Button.SELECT.getTxt()%>(小分類へ)</a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x032.js?v=<%=prm %>"></script>
