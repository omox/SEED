...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<tr>
		<td>
			<input class="easyui-numberbox" tabindex="1" id="<%=DefineReport.InpText.BMNCD.getObj()%>" check='<%=DefineReport.InpText.BMNCD.getMaxlenTag()%>' data-options="label:'部門',labelWidth:30,required:true" style="width:100px;" value="">
		</td>
		<td class="col_btn">
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	<div class="btn" style="float: left;">
		...
		<td><a href="#" title="CSV取込" id="<%=DefineReport.Button.CSV_IMPORT.getObj()%>" class="easyui-linkbutton" tabindex="905" iconCls="icon-ok" style="width:125px;"><span>CSV取込</span></a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.RP005.js?v=<%=prm %>"></script>
