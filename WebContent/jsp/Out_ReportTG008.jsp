...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<td colspan="4">
		...
		<tr>
			...
			<td class="labelCell" style="width: 30px;">一日遅</td>
			<td class="labelCell" style="width: 70px;">月締め</td>
			<td class="labelCell" style="width: 30px;">月締</td>
			<td class="labelCell" style="width: 70px;">最終締</td>
		</tr>
		<tr>
			...
			<td class="col_chk"><input type="checkbox" col="F4" style="vertical-align:middle;" disabled="disabled"></td>
			<td class="col_txt"><span col="F5"></span></td>
			<td class="col_chk"><input type="checkbox" col="F6" style="vertical-align:middle;" disabled="disabled"></td>
	...
	<tr>
	<td>部門</td>
	<td><select class="easyui-combobox" tabindex="1" id="<%=DefineReport.Select.BUMON.getObj()%>" style="width:110px;"></select></td>
	...
	<td>
		<table id="dTable2" class="dataTable">
		<tr>
			<td class="labelCell" style="width: 70px;">アンケート月度</td>
			<td class="labelCell" style="width: 30px;">月度枝番</td>
			<td class="labelCell" style="width: 70px;">アンケート作成日</td>
			<td class="labelCell" style="width: 30px;">本部ctrl</td>
		</tr>
		<tr>
			<td class="col_lbl_l" style="height: 20px;"><span col="F8"></span></td>
			<td class="col_lbl_l"><span col="F9"></span></td>
			<td class="col_lbl_c"><span col="F10"></span></td>
			<td class="col_chk"><input type="checkbox" col="F11" style="vertical-align:middle;" disabled="disabled" ></td>
		</tr>
		</table>
	</td>
	</tr>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td><a href="#" title="<%=DefineReport.Button.CANCEL.getTxt()%>" class="easyui-linkbutton" tabindex="5" id="<%=DefineReport.Button.CANCEL.getObj()%>" iconCls="icon-cancel" style="width:125px;"><span><%=DefineReport.Button.CANCEL.getTxt()%></span></a></td>
		<td><a href="#" title="登録" class="easyui-linkbutton" tabindex="6" id="<%=DefineReport.Button.UPD.getObj()%>" iconCls="icon-save" style="width:125px;"><span class="btnTxt">登録</span></a></td>
		<td><a href="#" title="選択(商品情報)" id="<%=DefineReport.Button.SEL_CHANGE.getObj()%>" class="easyui-linkbutton" tabindex="7" iconCls="icon-ok" style="width:125px;"><span>選択(商品情報)</span></a>
			<a href="#" title="選択(商品情報)" id="<%=DefineReport.Button.SEL_REFER.getObj()%>" class="easyui-linkbutton" tabindex="7" iconCls="icon-ok" style="width:125px;"><span>選択(商品情報)</span></a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.TG008.js?v=<%=prm %>"></script>
