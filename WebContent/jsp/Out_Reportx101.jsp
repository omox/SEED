...
<div id="search" data-options="region:'north',border:false" style="display:none;height:60px;padding:3px 8px 0;" >
	...
	<tr>
	<td>種別</td>
	<td><select class="easyui-combobox" tabindex="1" id="<%=DefineReport.MeisyoSelect.KBN617.getObj()%>" style="width:110px;" data-options="required:true"></select></td>
	<td>枝番</td>
	<td><input class="easyui-numberbox" tabindex="2" id="<%=DefineReport.InpText.FUTAIEDABAN.getObj()%>" check='<%=DefineReport.InpText.YOBIDASHICD.getMaxlenTag()%>' style="width:90px;"></td>
...
<div class="btn" style="float: left;">
	...
	<td></td>
	<td><a href="#" title="新規" id="<%=DefineReport.Button.NEW.getObj()%>" class="easyui-linkbutton" tabindex="102" iconCls="icon-add" style="width:125px;"><span class="btnTxt">新規</span></a></td>
	<td><a href="#" title="選択(変更)" id="<%=DefineReport.Button.SEL_CHANGE.getObj()%>" class="easyui-linkbutton" tabindex="103" iconCls="icon-ok" style="width:125px;"><span>選択(変更)</span></a></td>
	<td></td>
	</table>
</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x101.js?v=<%=prm %>"></script>
