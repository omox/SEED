...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<tr>
		<td>
			<input class="easyui-numberbox" tabindex="1" id="<%=DefineReport.InpText.TENCD.getObj()%>" check='<%=DefineReport.InpText.TENCD.getMaxlenTag()%>' data-options="label:'店コード',labelWidth:80" style="width:150px;" value="">
		</td>
	</tr>
	<tr>
		<td>
			<input class="easyui-textbox" tabindex="2" id="<%=DefineReport.InpText.TENKN.getObj()%>" check='<%=DefineReport.InpText.TENKN.getMaxlenTag()%>' data-options="label:'店舗名(漢字)',labelWidth:80" style="width:400px;" value="">店
		</td>
		<td class="col_btn">
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td>
			<a href="#" title="新規" id="<%=DefineReport.Button.NEW.getObj()%>" class="easyui-linkbutton" tabindex="902" iconCls="icon-add" style="width:125px;"><span class="btnTxt">新規</span></a>
			<a href="#" title="選択" id="<%=DefineReport.Button.SELECT.getObj()%>" class="easyui-linkbutton" tabindex="904" iconCls="icon-ok" style="width:125px;"><span>選択</span></a>
		</td>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x111.js?v=<%=prm %>"></script>
