...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<tr>
		<td>
		<input class="easyui-numberbox" col="F1" style="width:160px;" id="<%=DefineReport.InpText.HBSTDT.getObj()%>" check='<%=DefineReport.InpText.HBSTDT.getMaxlenTag()%>' value="" data-options="prompt:'<%=DefineReport.Label.PROMPT_DTW.getTxt()%>',label:'販売開始日',labelWidth:70,required:true" disabled="disabled">
		<input class="easyui-numberbox" col="F2" style="width:70px;" id="<%=DefineReport.InpText.BMNCD.getObj()%>" check='<%=DefineReport.InpText.BMNCD.getMaxlenTag()%>' value="" data-options="label:'部門',labelWidth:30,required:true" disabled="disabled">
		<input class="easyui-textbox"   col="F3" style="width:280px;" id="<%=DefineReport.InpText.MEISHOKN.getObj()%>" check='<%=DefineReport.InpText.MEISHOKN.getMaxlenTag()%>' value="" data-options="label:'名称',labelWidth:30,required:true" disabled="disabled">
	...
	<tr>
	<td>
		<input class="easyui-numberbox"  col="F6"   style="width:180px;" id="<%=DefineReport.InpText.DUMMYCD.getObj()%>" check='<%=DefineReport.InpText.DUMMYCD.getMaxlenTag()%>' value="" data-options="prompt:'____-____',label:'ダミーコード',labelWidth:90,required:true" disabled="disabled">
		<input class="easyui-textbox"  col="F7"   style="width:380px;" id="<%=DefineReport.InpText.POPKN.getObj()%>" check='<%=DefineReport.InpText.POPKN.getMaxlenTag()%>' value="" data-options="label:'ダミーコード名称',labelWidth:130,required:true" disabled="disabled">
	</td>
	</tr>
	</table>
</div>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	<div class="btn" style="float: left;">
		...
		<td><a href="#" title="削除"   class="easyui-linkbutton" tabindex="13" id="<%=DefineReport.Button.DEL.getObj()%>" title="<%=DefineReport.Button.DEL.getTxt()%>" iconCls="icon-remove" style="width:125px;"><span class="btnTxt" id="del" >削除</span><span class="btnTxt"  id="allDel">全削除</span></a></td>
		<td><a href="#" title="CSV出力" id="<%=DefineReport.Button.CSV.getObj()%>" class="easyui-linkbutton" tabindex="14" iconCls="icon-excel" style="width:125px;"><span>CSV出力</span></a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.BW002.js?v=<%=prm %>"></script>
