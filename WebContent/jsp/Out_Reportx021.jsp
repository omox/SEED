...
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	...
	<td><a href="#" title="選択(変更)" id="btn_sel_change" class="easyui-linkbutton" tabindex="4" iconCls="icon-ok" style="width:125px;"><span>選択(変更)</span></a>
 	</td>
	</tr>
	</table>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x021.js?v=<%=prm %>"></script>
