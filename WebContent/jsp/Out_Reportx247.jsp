...
<div data-options="region:'north',border:false" style="display:none;height:30px;padding:2px 5px 0;overflow: visible;" >
	<div class="lbl_box" style="width:930px;">
		...
		<input class="easyui-combobox" tabindex="-1" id="<%=DefineReport.Select.STCD_KENMEI.getObj() %>" data-options="label:'状態',labelWidth:30,editable:false" style="width:100px;">
		<input class="easyui-numberbox_" tabindex="-1" col="F1" id="<%=DefineReport.Text.SEL_SHNCD.getObj()%>" check='<%=DefineReport.InpText.SHNCD.getMaxlenTag()%>' readonly="readonly" data-options="label:'<%=DefineReport.Text.SEL_SHNCD.getTxt()%>',labelWidth:65,prompt:'<%=DefineReport.Label.PROMPT_SHNCD.getTxt()%>',readonly:true,editable:false" style="width:145px;">
		...
		<input type="hidden" id="<%=DefineReport.Text.YOYAKU.getObj()%>" value=0 />
		...
		<input type="hidden" id="<%=DefineReport.Hidden.STCD_TEIAN.getObj() %>" value="<%=request.getSession().getAttribute(DefineReport.Hidden.STCD_TEIAN.getObj()) %>">
...
<div data-options="region:'center',border:false" style="display:none;">
	...
	<div title="基本情報" style="display:none;padding:3px 8px;" data-options="selected:true">
		...
		<tr>
		<td>
			<div class="lbl_box" style="display:none;">
	...
	<div title="仕入・発注" style="display:none;padding:3px 8px;">
		...
		<td style="padding-right:8px;">
			...
			<tr>
			<td>
				<input class="easyui-numberbox_" tabindex="232" col="F31" id="<%=DefineReport.InpText.SSIRCD.getObj()%>" check='<%=DefineReport.InpText.SSIRCD.getMaxlenTag()%>' for_btn="<%=DefineReport.Button.SIR.getObj()%>_F1" data-options="label:'標準仕入先コード',labelWidth:130,readonly:true,editable:false" style="width:200px;">
			</td>
			<td class="lbl_box">
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x247.js?v=<%=prm %>"></script>
