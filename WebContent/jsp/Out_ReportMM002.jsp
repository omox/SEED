...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<tr>
		<td><input class="easyui-textbox" tabindex="1" col="F1" id="<%=DefineReport.InpText.TENCD.getObj()%>" data-options="label:'店コード',labelWidth:60,labelAlign:'right',prompt:'___'" style="width:120px;" value=""></td>
		<td><input class="easyui-textbox" tabindex="2" col="F2" id="<%=DefineReport.InpText.MOYSCD.getObj()%>" data-options="label:'催しコード',labelWidth:70,labelAlign:'right'",prompt:'_-______-___'" style="width:200px;" value=""></td>
		<td><input class="easyui-textbox" tabindex="3" col="F3" id="<%=DefineReport.InpText.BMNCD.getObj()%>" data-options="label:'部門コード',labelWidth:70,labelAlign:'right'" style="width:120px;" value=""></td>
		<td class="col_btn">
			<a href="#" title="店番表示" id="<%=DefineReport.Button.TENNOVIEW.getObj()%>" class="easyui-linkbutton" tabindex="4" iconCls="icon-search"><span class="btnTxt">店番表示</span></a>
		</td>
	</tr>
	</table>
</div>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	<div class="btn" style="float: left;">
		...
		<tr>
			...
			<td></td>
			<td><a href="#" title="選択(商品情報)" id="<%=DefineReport.Button.SEL_SHNINFO.getObj()%>" class="easyui-linkbutton" tabindex="7" iconCls="icon-ok" style="width:125px;"><span>選択(商品情報)</span></a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.MM002.js?v=<%=prm %>"></script>
