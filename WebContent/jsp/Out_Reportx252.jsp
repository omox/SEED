...
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	<div class="btn" style="float: left;">
		...
		<tr><th style="min-width:135px;"></th><th style="min-width:10px;"></th>
			<th style="width:135px;"><th style="width:135px;"></th></tr>
		<tr>
		<td><a href="#" title="戻る" onclick="top.window.location.href='../Servlet/Login2.do?MenuKbn=4'" class="easyui-linkbutton" tabindex="2" iconCls="icon-undo" style="width:125px;"><span class="btnTxt">戻る</span></a></td>
		<td></td>
		<!--<td><a href="#" tabindex="3" id="<%=DefineReport.Button.ERR_LIST.getObj()%>" title="<%=DefineReport.Button.ERR_LIST.getTxt()%>" class="easyui-linkbutton"iconCls="icon-ok"><span>エラーリスト出力</span></a></td>-->
		<td><a href="#" tabindex="4" id="<%=DefineReport.Button.ERR_CHANGE.getObj()%>" title="<%=DefineReport.Button.ERR_CHANGE.getTxt()%>" class="easyui-linkbutton" iconCls="icon-edit" style="width:130px;"><span>エラー修正</span></a></td>
	</tr>
	</table>
</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x252.js?v=<%=prm %>"></script>
