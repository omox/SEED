...
<div id="cc" class="easyui-layout" data-options="fit:true">
	<form id="ff" method="post" style="display: inline">
		...
		<div data-options="region:'center',border:false" style="display:none;padding:2px 5px 0;">
			<div class="easyui-datagrid" tabindex="7" id="gridholder" data-options="singleSelect:true,rownumbers:true, fit:true"></div>
	...
	<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 20px;">
		<div class="btn" style="float: left;">
			...
			<td></td>
			<td><a href="#" title="入力クリア" class="easyui-linkbutton" tabindex="10" id="<%=DefineReport.Button.CLEAR.getObj()%>" iconCls="icon-cancel" style="width:110px;"><%="入力クリア"%></a></td>
			<td></td>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.HT002.js?v=<%=prm %>"></script>
