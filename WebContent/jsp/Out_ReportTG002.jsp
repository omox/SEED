...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<TR align="left">
		...
		<TD class="col_lbl_c" style="WIDTH: 95px;"><span col="F1"></span></TD>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td>
			<a href="#" title="新規" id="<%=DefineReport.Button.NEW.getObj()%>" class="easyui-linkbutton" tabindex="3" iconCls="icon-add" style="width:125px;"><span class="btnTxt">新規</span></a>
			<a href="#" title="選択(店情報)" id="<%=DefineReport.Button.SEL_REFER.getObj()%>" class="easyui-linkbutton" tabindex="3" iconCls="icon-ok" style="width:125px;"><span>選択(店情報)</span></a>
		</td>
		<td><a href="#" title="選択(店情報)" id="<%=DefineReport.Button.SEL_CHANGE.getObj()%>" class="easyui-linkbutton" tabindex="4" iconCls="icon-ok" style="width:125px;"><span>選択(店情報)</span></a></td>
		<td><a href="#" title="コピー" id="<%=DefineReport.Button.COPY.getObj()%>" class="easyui-linkbutton" tabindex="5" iconCls="icon-ok" style="width:125px;"><span>コピー</span></a></td>
		<td><a href="#" title="強制グループ" id="<%=DefineReport.Button.NEW.getObj()%>2" class="easyui-linkbutton" tabindex="6" iconCls="icon-ok" style="width:125px;"><span>強制グループ</span></a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.TG002.js?v=<%=prm %>"></script>
