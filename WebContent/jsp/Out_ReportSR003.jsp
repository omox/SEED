...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<td style = "vertical-align:bottom">
		...
		<tr>
			<td class="labelCell" style="width: 95px;">商品コード</td>
			<td class="labelCell" style="width:300px;">商品名称</td>
		</tr>
		<tr>
	...
	<td style = "vertical-align:bottom">
		...
		<tr>
			<td class="labelCell" style="width: 50px;">部門コード</td>
		</tr>
		<tr>
			<td class="col_txt" style="height: 20px;"><span col="F3" style="text-align: right;"></span></td>
		</tr>
		</table>
	</td>
	<td style="width: 50px;"></td>
	<td style = "vertical-align:bottom">
		...
		<tr>
			<td class="labelCell" colspan=4 >レギュラー情報</td>
		<tr>
			<td class="labelCell" style="width: 50px;">原価</td>
			<td class="labelCell" style="width: 50px;">総売価</td>
			<td class="labelCell" style="width: 50px;">入数</td>
			<td class="labelCell" style="width: 50px;">値入率</td>
		</tr>
		<tr>
			<td class="col_txt" style="height: 20px;text-align: right;"><span col="F4" style="text-align: right;"></span></td>
			<td class="col_txt" style="text-align: right;"><span col="F5"></span></td>
			<td class="col_txt" style="text-align: right;"><span col="F6"></span></td>
			<td class="col_txt" style="text-align: right;"><span col="F7"></span></td>
		</tr>
		</table>
	</td>
	</tr>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.SR003.js?v=<%=prm %>"></script>
