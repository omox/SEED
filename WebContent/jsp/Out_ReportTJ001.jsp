...
<div id="list1" data-options="region:'north',border:false" style="display:none;" >
	<table id = "dTable1"  class="like_datagrid" data-options="rownumbers:true,width:598," style="float:left;">
		...
		<tbody>
			<tr>
				...
				<td class="col_tit" rowspan="1" style="width:220px;">タイトル</td>
				<td class="col_tit" rowspan="1" style="width:62px;">期間</td>
				<td class="col_tit" rowspan="1" style="width:90px;">送信締切日</td>
				<td class="col_tit" colspan="2" style="width:160px;">部門</td>
			</tr>
			<tr>
				...
				<td class="col_lbl_c" style="width:40px;text-align:left;"><span col="F5"></span></td>
	...
	<p style="clear:both;"></p>
				<table id = "grd_bumonyosan"  class="like_datagrid" data-options="rownumbers:true,width:410," style = "display:none">
				<thead class="no_header">
					<tr>
						<th style="max-width: 40px"></th>
						<th style="max-width: 40px"></th>
				...
				<tr>
					...
					<td class="col_num" ><input class="easyui-numberbox_" tabindex="1"   style="width:81px;" id="txt_yosan1" check='<%=DefineReport.InpText.BMNYSANAM.getMaxlenTag()%>'></td>
					<td class="col_num" ><input class="easyui-numberbox_" tabindex="2"   style="width:81px;" id="txt_yosan2" check='<%=DefineReport.InpText.BMNYSANAM.getMaxlenTag()%>'></td>
					<td class="col_num" ><input class="easyui-numberbox_" tabindex="3"   style="width:81px;" id="txt_yosan3" check='<%=DefineReport.InpText.BMNYSANAM.getMaxlenTag()%>'></td>
					<td class="col_num" ><input class="easyui-numberbox_" tabindex="4"   style="width:81px;" id="txt_yosan4" check='<%=DefineReport.InpText.BMNYSANAM.getMaxlenTag()%>'></td>
					<td class="col_num" ><input class="easyui-numberbox_" tabindex="5"   style="width:81px;" id="txt_yosan5" check='<%=DefineReport.InpText.BMNYSANAM.getMaxlenTag()%>'></td>
					<td class="col_num" ><input class="easyui-numberbox_" tabindex="6"   style="width:81px;" id="txt_yosan6" check='<%=DefineReport.InpText.BMNYSANAM.getMaxlenTag()%>'></td>
					<td class="col_num" ><input class="easyui-numberbox_" tabindex="7"   style="width:81px;" id="txt_yosan7" check='<%=DefineReport.InpText.BMNYSANAM.getMaxlenTag()%>'></td>
					<td class="col_num" ><input class="easyui-numberbox_" tabindex="8"   style="width:81px;" id="txt_yosan8" check='<%=DefineReport.InpText.BMNYSANAM.getMaxlenTag()%>'></td>
					<td class="col_num" ><input class="easyui-numberbox_" tabindex="9"   style="width:81px;" id="txt_yosan9" check='<%=DefineReport.InpText.BMNYSANAM.getMaxlenTag()%>'></td>
					<td class="col_num" ><input class="easyui-numberbox_" tabindex="10"   style="width:81px;" id="txt_yosan10" check='<%=DefineReport.InpText.BMNYSANAM.getMaxlenTag()%>'></td>
					<td class="col_lbl" style="width:91px; "><span id="txt_yosan_sum"></span></td>
					...
					<td class="col_tit" style="text-align:left" rowspan="2">構成比<br>納品売価計</td>
				</tr>
				<tr>
					...
					<td class="col_lbl_c" style="text-align:center"><span itext-align:center  ></span></td>
				</tr>
				</table>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 30px;text-align: center;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td><a href="#" class="easyui-linkbutton" tabindex="13" id="<%=DefineReport.Button.CLEAR.getObj()%>" title="<%=DefineReport.Button.CLEAR.getTxt()%>" iconCls="icon-cancel" style="width:110px;">入力クリア</a></td>
		<td><a href="#" class="easyui-linkbutton" tabindex="14" id="<%=DefineReport.Button.KOUSEIHI.getObj()%>" title="<%=DefineReport.Button.KOUSEIHI.getTxt()%>" iconCls="icon-ok" style="width:110px;">構成比</a></td>
		<td><a href="#" class="easyui-linkbutton" tabindex="15" id="<%=DefineReport.Button.SEL_VIEW.getObj()%>" title="<%=DefineReport.Button.SEL_VIEW.getTxt()%>" iconCls="icon-ok" style="width:110px;">分類明細</a></td>
		<td><a href="#" class="easyui-linkbutton" tabindex="16" id="<%=DefineReport.Button.SAIKEISAN.getObj()%>" title="<%=DefineReport.Button.SAIKEISAN.getTxt()%>" iconCls="icon-ok" style="width:110px;">再計算</a></td>
		<td><a href="#" class="easyui-linkbutton" tabindex="17" id="<%=DefineReport.Button.ADDLINE.getObj()%>" title="<%=DefineReport.Button.ADDLINE.getTxt()%>" iconCls="icon-ok" style="width:110px;">行追加</a>
			<a href="#" class="easyui-linkbutton" tabindex="18" id="<%=DefineReport.Button.UPD.getObj()%>" title="<%=DefineReport.Button.UPD.getTxt()%>" iconCls="icon-save" style="width:110px;"><span class="btnTxt"><%=DefineReport.Button.UPD.getTxt()%></span></a></td>
		</tr>
		</table>
	</div>
...
<div style="display:none;">
	<jsp:include page="Out_ReportwinTJ002.jsp" flush="true" />
	<jsp:include page="Out_ReportwinTJ003.jsp" flush="true" />
</div>
</body>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.TJ001.js?v=<%=prm %>"></script>
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.winTJ002.js?v=<%=prm %>"></script>
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.winTJ003.js?v=<%=prm %>"></script>
