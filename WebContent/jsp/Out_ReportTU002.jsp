...
<div id="cc" class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'north',border:false" style="display:none;">
			<TABLE id="dTable1" class="dataTable" cellspacing="0" cellpadding="0" style="display:inline;float:left;margin-top:4px;">
			<TBODY>
			<TR align="left">
				<TD class="labelCell" style="WIDTH: 30px;text-align:center">アンケート発注内容</TD>
				<TD>
					<input class="easyui-textbox" tabindex="-1" id="<%=DefineReport.InpText.MOYKN.getObj()%>" col="F1" data-options="cls:'labelInput'" style="width:250px;text-alien:center;" readonly="readonly">
				</TD>
			</TR>
			</TBODY>
			</TABLE>
		...
		<div data-options="region:'center',border:false" style="display:none;padding:2px 5px 0;">
			<div class="easyui-datagrid" tabindex="7" id="gridholder" data-options="singleSelect:true,rownumbers:false, fit:true"></div>
	...
	<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 20px;">
		<div class="btn" style="float: left;">
			...
			<td></td>
			<td><a href="#" title="入力クリア" class="easyui-linkbutton" tabindex="10" id="<%=DefineReport.Button.CLEAR.getObj()%>" iconCls="icon-cancel" style="width:110px;" data-options="disabled:true">入力クリア</a></td>
		...
		<div id="disp_record_info" style="float: right;">
			<span class="labelName" tabindex="-1" style="padding-top: 3px;">
				登録日 <span col="F2" id="<%=DefineReport.Text.ADDDT.getObj()%>"></span>　更新日 <span col="F3" id="<%=DefineReport.Text.UPDDT.getObj()%>"></span>　オペレータ <span col="F4" id="<%=DefineReport.Text.OPERATOR.getObj()%>"></span>
			</span>
			<input type="hidden" col="F5" name="<%=DefineReport.Hidden.UPDDT.getObj()%>" id="<%=DefineReport.Hidden.UPDDT.getObj()%>" />
		</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.TU002.js?v=<%=prm %>"></script>
