...
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td><a href="#" title="選択(参照)" id="<%=DefineReport.Button.SEL_REFER.getObj()%>" class="easyui-linkbutton" tabindex="22" iconCls="icon-ok" style="width:125px;"><span>選択(商品一覧)</span></a></td>
		<td><a href="#" title="<%=DefineReport.Button.CSV_IMPORT.getTxt()%>" id="<%=DefineReport.Button.CSV_IMPORT.getObj()%>" class="easyui-linkbutton" tabindex="23" 	iconCls="icon-excel" style="width:125px;"><span class="btnTxt">CSV取込</span></a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.JU001.js?v=<%=prm %>"></script>
