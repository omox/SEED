...
<div data-options="region:'north',border:false" style="display:none;height:30px;padding:2px 5px 0;overflow: visible;" >
	<div class="lbl_box" style="width:930px;">
		<span>
		<%=DefineReport.InpText.TEIANNO.getTxt() %>
		<input  class="easyui-textbox" tabindex="-1" col="F132" id="<%=DefineReport.InpText.TEIANNO.getObj() %>" readonly="readonly" style="width:150px" maxlength="<%=DefineReport.InpText.TEIANNO.getLen() %>">
		<select class="easyui-combobox" tabindex="-1" col="F133" id="<%=DefineReport.Select.STCD_SHIKAKARI.getObj()%>" data-options="label:'状態',labelWidth:30" style="width:115px;"></select>
		</span>
		...
		<input type="hidden" id="<%=DefineReport.Hidden.STCD_SHIKAKARI.getObj() %>" value="">

		<input type="hidden" tabindex="-1" id="<%=DefineReport.Text.YOYAKU.getObj()%>" value=0 />
		<input type="hidden" tabindex="-1" id="<%=DefineReport.InpText.YOYAKUDT.getObj()%>" value="">
		<input type="hidden" tabindex="-1" id="<%=DefineReport.InpText.TENBAIKADT.getObj()%>" value="">
...
<div id="debug" style="visibility: hidden;">
	...
	<input type="hidden" name="userYobi1" id="userYobi1" value="<%=userYobi1 %>"/>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x251.js?v=<%=prm %>"></script>
