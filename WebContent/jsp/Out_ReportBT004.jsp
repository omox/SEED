...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 30px;text-align: center;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td><a href="#" title="新規" id="<%=DefineReport.Button.NEW.getObj()%>" class="easyui-linkbutton" tabindex="6" iconCls="icon-add" style="width:125px;"><span class="btnTxt">新規</span></a></td>
		<td><a href="#" title="選択(明細)" id="<%=DefineReport.Button.SEL_REFER.getObj()%>" class="easyui-linkbutton" tabindex="7" iconCls="icon-ok" style="width:125px;"><span>選択(明細)</span></a>
		<a href="#" title="選択(変更)" id="<%=DefineReport.Button.SEL_CHANGE.getObj()%>" class="easyui-linkbutton" tabindex="7" iconCls="icon-ok" style="width:125px;"><span>選択(変更)</span></a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.BT004.js?v=<%=prm %>"></script>
