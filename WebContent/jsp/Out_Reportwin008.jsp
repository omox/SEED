...
<%
	String page_suffix = "_win008";
%>
<div id="<%=page_suffix%>" title="<%=DefineReport.Button.EHSPTN.getTxt()%>" style="width:905px;height:500px;position: relative;display:none;">
	<div id="el<%=page_suffix%>" class="easyui-layout" data-options="fit:true" style="pading:0;">
		<div data-options="region:'north',border:false" style="height:0px;width:100%;padding:0px 5px 0;">
			<div class="Search">
				...
				<tr>
					<td style="text-align: right;width:905px">
						<a href="#" class="easyui-linkbutton" tabindex="1001" id="<%=DefineReport.Button.TENPO.getObj()%>" title="<%=DefineReport.Button.TENPO.getTxt()%>" iconCls="icon-search" style="width:180px;float:right;"><span>店舗一覧</span></a>
					</td>
				</tr>
				</tbody></table>
			</div>
		...
		<div data-options="region:'center',border:false" style="display:none;">
			<div class="easyui-datagrid placeFace" tabindex="1003" id="<%=DefineReport.Grid.EHSPTN.getObj()%><%=page_suffix%>"></div>
		</div>
