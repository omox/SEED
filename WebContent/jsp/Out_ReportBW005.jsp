...
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	...
	<td><a href="#" title="選択(参照)" class="easyui-linkbutton" tabindex="102" id="<%=DefineReport.Button.SEL_REFER.getObj()%>" iconCls="icon-ok" style="width:125px;"><span>選択(参照)</span></a></td>
	<td><a href="#" title="選択(商品一覧)" id="btn_sel_change" class="easyui-linkbutton" tabindex="103" iconCls="icon-ok" style="width:125px;"><span>選択(変更)</span></a>
	<td><a href="#" title="CSVエラー選択" id="<%=DefineReport.Button.SEL_CSVERR.getObj()%>" class="easyui-linkbutton" tabindex="104" iconCls="icon-ok" style="width:125px;"><span>CSVエラー選択</span></a></td>
	<td><a href="#" title="CSV取込" id="<%=DefineReport.Button.CSV_IMPORT.getObj()%>" class="easyui-linkbutton" tabindex="105" iconCls="icon-excel" style="width:125px;"><span class="btnTxt">CSV取込</span></a></td>
	<td></td>
 	</td>
	</tr>
	</table>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.BW005.js?v=<%=prm %>"></script>
