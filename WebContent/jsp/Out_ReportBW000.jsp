...
<div id="search" data-options="region:'north',border:false" style="display:none;height:250px;padding:20px 8px 0;text-align:center;" >
	...
	<tr>
	<td colspan="2"></td>
	<td class="lbl_box"><div><input class="easyui-textbox" tabindex="-1" id="<%=DefineReport.Text.ERR_NUMBER.getObj()%>" readonly="readonly" data-options="label:'エラー件数',labelWidth:70,readonly:true,editable:false" style="width:150px;text-align: right">　件</div></td>
	</tr>
	<tr>
	<td colspan="2"></td>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.BW000.js?v=<%=prm %>"></script>
