...
<%
	String page_suffix = "_win003";
%>
<div id="<%=page_suffix%>" title="<%=DefineReport.Button.TENGP.getTxt()%>" style="width:600px;height:450px;position: relative;display:none;">
	<div id="el<%=page_suffix%>" class="easyui-layout" data-options="fit:true" style="pading:0;">
		<div data-options="region:'north',border:false" style="height:70px;width:100%;padding:2px 5px 0;">
			<div class="Search">
				...
				<tr vAlign="middle">
				<td>店舗グループ名（漢字）</td>
				<td><input class="easyui-textbox" tabindex="1001" id="<%=DefineReport.InpText.TENGPKN.getObj()%><%=page_suffix%>" check='<%=DefineReport.InpText.TENGPKN.getMaxlenTag()%>' style="width:305px;"></td>
		...
		<div data-options="region:'center',border:false" style="display:none;">
			<div class="easyui-datagrid placeFace" tabindex="1003" id="<%=DefineReport.Grid.TENGP.getObj()%><%=page_suffix%>"></div>
		</div>
