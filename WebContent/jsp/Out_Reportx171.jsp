...
<table class="t-layout1">
	<tr>
		<td><%=DefineReport.InpText.HSPTN.getTxt()%></td>
		<td><input class="easyui-numberbox" tabindex="1" id="<%=DefineReport.InpText.HSPTN.getObj()%>" check='<%=DefineReport.InpText.HSPTN.getMaxlenTag()%>' style="width:100px;"></td>
		<td><%=DefineReport.InpText.HSPTNKN.getTxt()%></td>
		<td><input class="easyui-textbox" tabindex="2" id="<%=DefineReport.InpText.HSPTNKN.getObj()%>" check='<%=DefineReport.InpText.HSPTNKN.getMaxlenTag()%>' for_inp="<%=DefineReport.InpText.HSPTN.getObj()%>_F2" style="width:300px;"></td>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 30px;text-align: center;">
	...
	<td></td>
	<td><a href="#" title="新規" 		id="btn_new" class="easyui-linkbutton" tabindex="6" iconCls="icon-add" style="width:125px;"><span class="btnTxt">新規</span></a></td>
	<td><a href="#" title="選択(変更)" 	id="btn_sel_change" class="easyui-linkbutton" tabindex="7" iconCls="icon-ok" style="width:125px;"><span>選択(変更)</span></a>
 	</td>
	</tr>
	</table>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x171.js?v=<%=prm %>"></script>
