...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<td colspan="4">
		...
		<tr>
			<td class="labelCell" style="width: 75px;text-align: center;">カタログNo</td>
			<td class="labelCell" style="width: 95px;text-align: center;">商品コード</td>
			<td class="labelCell" style="width:300px;text-align: center;">商品名</td>
			<td class="labelCell" style="width: 95px;text-align: center;">原価</td>
			<td class="labelCell" style="width: 95px;text-align: center;">本売価</td>
			<td class="labelCell" style="width: 95px;text-align: center;">総額売価</td>


		</tr>
		<tr>
			<td class="col_txt" style="height: 20px;text-align: right;"><span col="F1"></span></td>
			<td class="col_txt"><span col="F2"></span></td>
			<td class="col_txt"><span col="F3"></span></td>
			<td class="col_txt" style="text-align: right;"><span col="F4"></span></td>
			<td class="col_txt" style="text-align: right;"><span col="F5"></span></td>
			<td class="col_txt" style="text-align: right;"><span col="F6"></span></td>
		</tr>
		</table>
	</td>
	</tr>
...
<div id="list" data-options="region:'center',border:false" style="display:none;">
	...
	<div class="ref_editor" style="display: none;">
		...
		<input class="easyui-numberbox" tabindex="-1" id="<%=DefineReport.InpText.SOUSU.getObj()%>"  check='<%=DefineReport.InpText.SOUSU.getMaxlenTag()%>'>
	</div>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 30px;text-align: center;">
	...
	<tr>
		...
		<td></td>
		<td><a href="#" title="入力クリア" class="easyui-linkbutton" tabindex="3" id="<%=DefineReport.Button.CLEAR.getObj()%>" iconCls="icon-cancel" style="width:110px;">入力クリア</a></td>
		<td><a href="#" class="easyui-linkbutton" tabindex="4" id="<%=DefineReport.Button.UPD.getObj()%>" title="<%=DefineReport.Button.UPD.getTxt()%>" iconCls="icon-save" style="width:125px;"><span class="btnTxt"><%=DefineReport.Button.UPD.getTxt()%></span></a></td>
	</tr>
	</table>
</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.HY003.js?v=<%=prm %>"></script>
