...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	<table class="t-layout1">
		<tr>
			<td>
				<%=DefineReport.InpText.HSGPKN.getTxt()%>
				<input class="easyui-textbox" tabindex="1" id="<%=DefineReport.InpText.HSGPKN.getObj()%>" check='<%=DefineReport.InpText.HSGPKN.getMaxlenTag()%>' style="width:350px;" value="">
			</td>
			<td class="col_btn">
				<a href="#" title="検索" id="btn_search" class="easyui-linkbutton" tabindex="2" iconCls="icon-search"><span class="btnTxt">検索</span></a>
			</td>
		<tr>
	</table>
<div>
...
<div id="list" data-options="region:'center',border:false" style="display:none;">
	...
	<div class="ref_editor" style="display: none;">
		<input class="easyui-numberbox" tabindex="-1" col="F1"  id='<%=DefineReport.InpText.HSGPCD.getObj()%>' check='<%=DefineReport.InpText.HSGPCD.getMaxlenTag()%>'>
	</div>
</div>
</form>
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 20px;">
	<div class="btn" style="float: left;">
		...
		<tr>
			...
			<th style="min-width:160px;"></th></tr>
		<tr>
		...
		<td><a href="#" class="easyui-linkbutton" tabindex="6" id="<%=DefineReport.Button.SEL_CHANGE.getObj()%>" title="<%=DefineReport.Button.SEL_CHANGE.getTxt()%>" iconCls="icon-ok" style="width:125px;"><span>選択(変更)</span></a></td>
		<td></td>
		<td><a href="#" class="easyui-linkbutton" tabindex="8" id="<%=DefineReport.Button.SEL_REFER_TENG.getObj()%>" title="<%=DefineReport.Button.SEL_REFER_TENG.getTxt()%>" iconCls="icon-ok" style="width:150px;"><span>選択(店グループ一覧)</span></a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x201.js?v=<%=prm %>"></script>
