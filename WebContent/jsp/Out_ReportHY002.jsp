...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<td colspan="4">
		...
		<tr>
			<td class="labelCell" style="width: 95px;text-align: center;">企画No</td>
			<td class="labelCell" style="width:300px;text-align: center;">企画名</td>
		</tr>
		<tr>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.HY002.js?v=<%=prm %>"></script>
