...
<div id="cc" class="easyui-layout" data-options="fit:true">
			...
			<table class="t-layout1" style="float:left;margin-right:5px;margin-left:10px;">
				<tr>
					...
					<td style="height:30px;">
						<div class="inp_box">
							<input class="easyui-combobox" tabindex="6" id="<%=DefineReport.Select.YOBIKBN1.getObj()%>" data-options="label:'曜日',labelWidth:35,panelHeight:200,required:true" style="width:90px;">
						</div>
					</td>
					<td style="height:30px;">
					...
					<td>
						<a href="#" title="入力済商品一覧" tabindex="8" id="<%=DefineReport.Button.SUB.getObj()%>_winHT005" class="easyui-linkbutton" iconCls="icon-search" style="width:120px;"><span class="btnTxt" style="width: 80px;">入力済商品一覧</span></a>
					</td>
				</tr>
			</table>
		</div>
		<div data-options="region:'center',border:false" style="display:none;padding:2px 5px 0;">
			<div class="easyui-datagrid" tabindex="9" id="gridholder" data-options="singleSelect:true,rownumbers:true, fit:true"></div>
	...
	<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 20px;">
		<div class="btn" style="float: left;">
			...
			<td></td>
			<td><a href="#" title="入力クリア" class="easyui-linkbutton" tabindex="12" id="<%=DefineReport.Button.CLEAR.getObj()%>" iconCls="icon-cancel" style="width:110px;"><%="入力クリア"%></a></td>
			<td></td>
			<td><a href="#" title="登録" class="easyui-linkbutton" tabindex="13" id="<%=DefineReport.Button.UPD.getObj()%>" title="<%=DefineReport.Button.UPD.getTxt()%>" iconCls="icon-save" style="width:110px;"><span class="btnTxt"><%=DefineReport.Button.UPD.getTxt()%></span></a></td>
			</tr>
			</table>
		</div>
	</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.HT009.js?v=<%=prm %>"></script>
