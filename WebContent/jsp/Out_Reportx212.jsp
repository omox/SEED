...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 20px;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td>
		<a href="#" class="easyui-linkbutton" tabindex="3" id="<%=DefineReport.Button.SEL_CHANGE.getObj()%>" title="選択(変更)" iconCls="icon-ok" style="width:125px;"><span>選択(変更)</span></a>
		<a href="#" class="easyui-linkbutton" tabindex="4" id="<%=DefineReport.Button.SEL_REFER.getObj()%>" title="選択(参照)" iconCls="icon-ok" style="width:125px;"><span>選択(参照)</span></a>
		</td>
		</tr>
		</table>
	</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x212.js?v=<%=prm %>"></script>
