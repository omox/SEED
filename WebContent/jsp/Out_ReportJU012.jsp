...
<table class="t-layout1">
	...
	<tr>
		<td>
			...
			<input class="easyui-numberbox" tabindex="9" col="F10" id="<%=DefineReport.InpText.RG_BAIKAAM.getObj()%>" for_inp="<%=DefineReport.InpText.SHNCD.getObj()%>_F5" check='<%=DefineReport.InpText.RG_BAIKAAM.getMaxlenTag()%>' data-options="label:'　　　総売価',labelWidth:95,required:true,min:0" style="width:205px;text-align: right;">
...
<table>
	...
	<tr>
		<td>
			<input class="easyui-numberbox" col="F15" tabindex="15" id="<%=DefineReport.InpText.HTSU.getObj()%>" check='<%=DefineReport.InpText.HTSU.getMaxlenTag()%>' data-options="label:'発注数',labelWidth:60,min:1" style="width:115px;text-align:right" />
		</td>
	</tr>
</table>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.JU012.js?v=<%=prm %>"></script>
