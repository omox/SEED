...
<div id="list1" data-options="region:'north',border:false," style="display:none;" >
	...
	<p style="clear:both;"></p>
				<table id = "grd_bumonyosan"  class="like_datagrid" data-options="rownumbers:true,width:410," style="float:left;display:none;">
				<thead class="no_header">
					<tr>
				...
				<tr>
					...
					<div style="width:51px;">入り数</div>
					<div>ODS</div>
					<div></div>
					</td>
					<td class="col_tit" rowspan="3" style="width:61px;text-align:left;vertical-align:top;">
					<div style="width:61px;">事前原価</div>
					<div>追加原価</div>
					<div>標準原価</div>
					</td>
					<td class="col_tit" rowspan="3" style="width:61px;text-align:left;vertical-align:top;">
					<div style="width:61px;">特売総売</div>
					<div>特売本部</div>
					<div>標準総売</div>
					</td>
					<td class="col_tit" style="width:64px;text-align:left"><div style="width:72px;">日付</div></td>
					<td class="col_lbl_c"><div id="txt_day1" style="width:81px;"></div></td>
					<td class="col_lbl_c"><div id="txt_day2" style="width:81px;"></div></td>
					<td class="col_lbl_c"><div id="txt_day3" style="width:81px;"></div></td>
					<td class="col_lbl_c"><div id="txt_day4" style="width:81px;"></div></td>
					<td class="col_lbl_c"><div id="txt_day5" style="width:81px;"></div></td>
					<td class="col_lbl_c"><div id="txt_day6" style="width:81px;"></div></td>
					<td class="col_lbl_c"><div id="txt_day7" style="width:81px;"></div></td>
					<td class="col_lbl_c"><div id="txt_day8" style="width:81px;"></div></td>
					<td class="col_lbl_c"><div id="txt_day9" style="width:81px;"></div></td>
					<td class="col_lbl_c"><div id="txt_day10" style="width:81px;"></div></td>
				</tr>
				<tr>
					<td class="col_tit" style="text-align:left">曜日</td>
					<td class="col_lbl_c" style="text-align:left"><span id="txt_youbi1"  ></span></td>
					<td class="col_lbl_c" style="text-align:left"><span id="txt_youbi2"  ></span></td>
					<td class="col_lbl_c" style="text-align:left"><span id="txt_youbi3"  ></span></td>
					<td class="col_lbl_c" style="text-align:left"><span id="txt_youbi4"  ></span></td>
					<td class="col_lbl_c" style="text-align:left"><span id="txt_youbi5"  ></span></td>
					<td class="col_lbl_c" style="text-align:left"><span id="txt_youbi6"  ></span></td>
					<td class="col_lbl_c" style="text-align:left"><span id="txt_youbi7"  ></span></td>
					<td class="col_lbl_c" style="text-align:left"><span id="txt_youbi8"  ></span></td>
					<td class="col_lbl_c" style="text-align:left"><span id="txt_youbi9"  ></span></td>
					<td class="col_lbl_c" style="text-align:left"><span id="txt_youbi10"  ></span></td>
				</tr>
				</table>
</div>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 30px;text-align: center;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td><a href="#" class="easyui-linkbutton" tabindex="3" id="<%=DefineReport.Button.CLEAR.getObj()%>" title="<%=DefineReport.Button.CLEAR.getTxt()%>" iconCls="icon-cancel" style="width:110px;">入力クリア</a></td>
		<td><a href="#" class="easyui-linkbutton" tabindex="4" id="<%=DefineReport.Button.SAIKEISAN.getObj()%>" title="<%=DefineReport.Button.SAIKEISAN.getTxt()%>" iconCls="icon-ok" style="width:110px;">再計算</a></td>
		...
		<td><a href="#" class="easyui-linkbutton" tabindex="6" id="<%=DefineReport.Button.ADDLINE.getObj()%>" title="<%=DefineReport.Button.ADDLINE.getTxt()%>" iconCls="icon-ok" style="width:110px;">行追加</a></td>
		</tr>
		</table>
	</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.TJ011.js?v=<%=prm %>"></script>
