...
<div data-options="region:'center',border:false" style="display:none;padding:2px 5px 0;">
	...
	<div class="ref_editor" style="display: none;">
		...
		<input  class="easyui-numberbox" tabindex="-1" id="<%=DefineReport.InpText.TENCD.getObj()%>" check='<%=DefineReport.InpText.TENCD.getMaxlenTag()%>' style="width:60px;"/>
		<input  class="easyui-textbox"   tabindex="-1" id="<%=DefineReport.InpText.TENKN.getObj()%>" for_inp="<%=DefineReport.InpText.TENCD.getObj()%>_F3" check='<%=DefineReport.InpText.BMNKN.getMaxlenTag()%>' />
		<input  class="easyui-numberbox" tabindex="-1" id="<%=DefineReport.InpText.BMNCD.getObj()%>" check='<%=DefineReport.InpText.BMNCD.getMaxlenTag()%>' style="width:60px;"/>
		<input  class="easyui-textbox"   tabindex="-1" id="<%=DefineReport.InpText.BMNKN.getObj()%>" for_inp="<%=DefineReport.InpText.BMNCD.getObj()%>_TEXT2" check='<%=DefineReport.InpText.BMNKN.getMaxlenTag()%>' />
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x216.js?v=<%=prm %>"></script>
