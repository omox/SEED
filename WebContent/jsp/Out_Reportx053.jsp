...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<tr>
		<td><%="代表" + DefineReport.InpText.MAKERCD.getTxt()%></td>
		<td><input class="easyui-textbox" tabindex="-1" id="<%=DefineReport.InpText.MAKERCD.getObj()%>" check='<%=DefineReport.InpText.MAKERCD.getMaxlenTag()%>' style="width:100px;" value=""></td>
		<td><%="代表" + DefineReport.InpText.MAKERKN.getTxt()%></td>
		<td><input class="easyui-textbox" tabindex="-1" id="<%=DefineReport.InpText.MAKERKN.getObj()%>" check='<%=DefineReport.InpText.MAKERKN.getMaxlenTag()%>' style="width:200px;" value=""></td>
	</tr>
	</table>
<div>
</div>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 30px;text-align: center;">
	...
	<td></td>
	<td><a href="#" title="選択(参照)" id="<%=DefineReport.Button.SEL_REFER.getObj()%>" class="easyui-linkbutton" tabindex="3" iconCls="icon-ok" style="width:125px;"><span>選択(参照)</span></a>
	<a href="#" title="選択(変更)" id="btn_sel_change" class="easyui-linkbutton" tabindex="3" iconCls="icon-ok" style="width:125px;"><span>選択(変更)</span></a></td>
	</tr>
	</table>
</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x053.js?v=<%=prm %>"></script>
