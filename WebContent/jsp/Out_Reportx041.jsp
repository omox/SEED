...
<!-- <div id="search" data-options="region:'north',border:false" style="display:none;height:120px;padding:3px 8px 0;" >
</div> -->
<a href="#" title="検索" id="btn_search" class="easyui-linkbutton" tabindex="-1" iconCls="icon-search"><span class="btnTxt">検索</span></a>
</form>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 30px;text-align: center;">
	...
	<td></td>
	<td><a href="#" title="新規" id="btn_new" class="easyui-linkbutton" tabindex="3" iconCls="icon-add" style="width:125px;"><span class="btnTxt">新規</span></a></td>
	<td><a href="#" title="選択(変更)" id="btn_sel_change" class="easyui-linkbutton" tabindex="4" iconCls="icon-ok" style="width:125px;"><span>選択(変更)</span></a></td>
	</tr>
	</table>
</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x041.js?v=<%=prm %>"></script>
