...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<TBODY>
	<TR align="left">
		<TD class="labelCell" style="WIDTH: 60px;">月度</TD>
		<TD class="col_lbl_r" style="WIDTH: 35px;"><span col="F1"></span></TD>
		<TD class="labelCell" style="WIDTH: 60px;">枝番</TD>
		<TD class="col_lbl_r" style="WIDTH: 15px;"><span col="F2" ></span></TD>
		<TD class="labelCell" style="WIDTH: 60px;">催しコード</TD>
		<TD class="col_lbl_r" style="WIDTH: 85px;"><span col="F3"></span></TD>
		<TD class="labelCell" style="WIDTH: 60px;">催し名称</TD>
		<TD class="col_lbl_r" style="WIDTH:300px;text-align:left" ><span col="F4"></span></TD>
		<TD class="labelCell" style="WIDTH: 60px;">催し期間</TD>
		<TD class="col_lbl_r" style="WIDTH:175px;"><span col="F5"></span></TD>
		<TD class="labelCell" style="WIDTH: 60px;">1日遅れパタン</TD>
		<TD class="col_chk" style="WIDTH:25px;"><input type="checkbox" col="F6" readonly="readonly" disabled="disabled"/></TD>
	</TR></TBODY></TABLE>
</div>
</form>
...
<div id="list" data-options="region:'center',border:false" style="display:none;">
	...
	<!-- EasyUI方式 -->
	<div tabindex="1" id="gridholder" class="easyui-datagrid" ></div>
</div>
</form>
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td><a href="#" title="選択(グループ・店別)" id="<%=DefineReport.Button.NEW.getObj()%>" class="easyui-linkbutton" tabindex="12" iconCls="icon-ok" style="width:200px;"><span>選択(グループ・店別)</span></a></td>
		<td><a href="#" title="選択(グループ・催し別)" id="<%=DefineReport.Button.SEL_CHANGE.getObj()%>" class="easyui-linkbutton" tabindex="13" iconCls="icon-ok" style="width:200px;"><span>選択(グループ・催し別)</span></a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.TG013.js?v=<%=prm %>"></script>
