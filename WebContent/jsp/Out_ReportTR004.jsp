...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	<table class="t-layout1">
		<tr>
			<td>
				<div class="inp_box"><input class="easyui-combobox" tabindex="1" id="<%=DefineReport.Select.BUMON.getObj()%>" data-options="label:'部門',labelWidth:80,panelHeight:200,required:true" style="width:290px;"></div>
			</td>
		</tr>
		<tr>
			<td>
				<div class="inp_box"><input class="easyui-combobox" tabindex="2" id="<%=DefineReport.Select.DAI_BUN.getObj()%>" data-options="label:'大分類',labelWidth:80,panelHeight:200,required:true" style="width:290px;"></div>
			</td>
		</tr>
		<tr>
			<td>
				<div class="inp_box"><input class="easyui-combobox" tabindex="3" id="<%=DefineReport.Select.CHU_BUN.getObj()%>" data-options="label:'中分類',labelWidth:80,panelHeight:200,required:true" style="width:290px;"></div>
			</td>
		</tr>
		<tr>
			<td>
			 	<input class="easyui-numberbox" tabindex="4" id="<%=DefineReport.InpText.SHNCD.getObj()%>" check='<%=DefineReport.InpText.SHNCD.getMaxlenTag()%>' data-options="prompt:'____-____',label:'商品コード',labelWidth:80,min:0" style="width:165px;">
			</td>
			<td class="col_btn">
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 20px;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td>
		<a href="#" class="easyui-linkbutton" tabindex="8" id="<%=DefineReport.Button.SEL_CHANGE.getObj()%>" title="<%=DefineReport.Button.SEL_CHANGE.getTxt()%>" iconCls="icon-ok" style="width:125px;"><span>選択(店別数量)</span></a>
		<a href="#" class="easyui-linkbutton" tabindex="9" id="<%=DefineReport.Button.SEL_REFER.getObj()%>" title="<%=DefineReport.Button.SEL_REFER.getTxt()%>" iconCls="icon-ok" style="width:125px;"><span>選択(参照)</span></a>
		</td>
		</tr>
		</table>
	</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.TR004.js?v=<%=prm %>"></script>
