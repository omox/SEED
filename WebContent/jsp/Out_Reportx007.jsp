...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	<div id="reference" style="overflow: hidden;width:100%;">
		...
		<TR align="left">
			...
			<TD><input class="easyui-numberbox" tabindex="-1" id="<%=DefineReport.Text.ERR_NUMBER.getObj()%>" data-options="cls:'labelInputNum'" style="width:65px;" readonly="readonly"></TD>
		</TR></TBODY></TABLE>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x007.js?v=<%=prm %>"></script>
