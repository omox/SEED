		...
		<div data-options="region:'north',border:false" style="display:none;">
			<table class="t-layout1" style="margin:10px 10px 0px 10px;">
				<tr>
					...
					<td>
						<div class="inp_box"><input class="easyui-combobox" tabindex="3" id="<%=DefineReport.Select.DAI_BUN.getObj()%>" data-options="label:'大分類',labelWidth:45,panelHeight:200,required:true" style="width:250px;"></div>
					</td>
					<td>
						<div class="inp_box"><input class="easyui-combobox" tabindex="4" id="<%=DefineReport.Select.CHU_BUN.getObj()%>" data-options="label:'中分類',labelWidth:45,panelHeight:200,required:true" style="width:250px;"></div>
					</td>
				</tr>
			</table>
			<table class="t-layout1" style="float:left;margin-right:5px;margin-left:10px;">
				<tr>
					<td style="height:30px;">
						<div class="inp_box">
							<input class="easyui-combobox" tabindex="5" id="<%=DefineReport.Select.YOBIKBN1.getObj()%>" data-options="label:'曜日',labelWidth:35,panelHeight:200,required:true" style="width:90px;">
						</div>
					</td>
					<td style="height:30px;">
			...
			<TBODY>
			<TR align="left">
				<TD class="labelCell" style="WIDTH: 30px;text-align:center">期間</TD>
				<TD>
					<input class="easyui-textbox" tabindex="-1" id="<%=DefineReport.Text.SHUNOPERIOD.getObj()%>" data-options="cls:'labelInputNum'" style="width:205px;text-alien:center;" readonly="readonly">
					<input type="hidden" name="<%=DefineReport.Text.SHORIDTWEEK.getObj()%>" id="<%=DefineReport.Text.SHORIDTWEEK.getObj()%>" />
				</TD>
			</TR>
			</TBODY>
			</TABLE>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.HT004.js?v=<%=prm %>"></script>
