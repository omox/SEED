...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<tr>
		<td><input class="easyui-textbox" tabindex="1" col="F1" id="<%=DefineReport.InpText.SHNCD.getObj()%>"  data-options="label:'商品コード',labelWidth:80" style="width:160px;" value=""></td>
		<td><input class="easyui-textbox" tabindex="2" col="F2" id="<%=DefineReport.InpText.SHNKN.getObj()%>"  data-options="label:'商品名',labelWidth:50" style="width:500px;" value=""></td>
	</tr>
	<tr>
		<td><input class="easyui-textbox" tabindex="3" col="F3" id="<%=DefineReport.InpText.MOYSCD.getObj()%>"  data-options="label:'催しコード',labelWidth:80" style="width:180px;" value=""></td>
	</tr>
	</table>
	<table>
	<tr>
		<td>
			...
			<tr>
			<!--
				<td class="col_txt" style="height: 20px;text-align:right;"><span col="F4"></span></td>
			 -->
		...
		<td class="col_btn">
			<a href="#" title="店番順" id="<%=DefineReport.Button.TENNOORDER.getObj()%>" class="easyui-linkbutton" tabindex="4" iconCls="icon-search"  style="width:80px; text-align: left;"><span class="btnTxt">店番順</span></a>
		</td>
	</tr>
	</table>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.MM003.js?v=<%=prm %>"></script>
