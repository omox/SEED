...
<div id="search" data-options="region:'north',border:false" style="display:none;height:40px;padding:3px 8px 0;" >
	...
	<%=DefineReport.InpText.SHOCD.getTxt()%>
	<input class="easyui-numberbox" tabindex="5" id="<%=DefineReport.InpText.SHOCD.getObj()%>" check='<%=DefineReport.InpText.SHOCD.getMaxlenTag()%>' data-options="required:true" style="width:80px;">
...
<div id="list" data-options="region:'center',border:false" style="display:none;">
	...
	<!-- EasyUI方式 -->
	<div tabindex="6" id="gridholder" class="easyui-datagrid" data-options="fit:true"></div>
	<!-- <table>
		<tr>
	...
	<div class="ref_editor" style="display: none;">
		<input class="easyui-numberbox" tabindex="-1" col="F1"  id='txt_f1'  check='<%=DefineReport.InpText.SSHOCD.getMaxlenTag()%>'/>
		<input class="easyui-textbox" 	tabindex="-1" col="F2"  id="txt_f2"  check='<%=DefineReport.InpText.SSHOBRUIAN.getMaxlenTag()%>'data-options="editable:true">
		<input class="easyui-textbox" 	tabindex="-1" col="F3"  id="txt_f3"  check='<%=DefineReport.InpText.SSHOBRUIKN.getMaxlenTag()%>'data-options="editable:true">
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 30px;text-align: center;align: left;">
		...
		<tr>
		<td><a href="#" title="戻る" id="<%=DefineReport.Button.BACK.getObj()%>" class="easyui-linkbutton" tabindex="7" iconCls="icon-undo" style="width:110px;"><span class="btnTxt">戻る</span></a></td>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x034.js?v=<%=prm %>"></script>
