...
<div id="list1" data-options="region:'north',border:false" style="display:none;" >
	<table id = "dTable1"  class="like_datagrid" data-options="rownumbers:true,width:598," style="float:left;">
		...
		<tbody>
			<tr>
				<td class="col_tit" rowspan="1" style="width:60px;">リスト№</td>
	...
	<p style="clear:both;"></p>
				...
				<tr>
					...
					<td class="col_tit" rowspan="3" style="width:51px;text-align:left;vertical-align:top;"><span></span><br>
					<div style="width:51px;">単位</div>
					<br>
					<br>
					</td>
					...
					<td class="col_tit" style="width:81px;text-align:left" rowspan="3">
					<span>重量計</span><br>
					<span>数量系</span><br>
					<span>納品売価計</span><br>
					<span>納品原価系</span>
...
<div style="display:none;">
	<jsp:include page="Out_ReportwinTJ006.jsp" flush="true" />
	<jsp:include page="Out_ReportwinTJ007.jsp" flush="true" />
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.TJ005.js?v=<%=prm %>"></script>
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.winTJ006.js?v=<%=prm %>"></script>
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.winTJ007.js?v=<%=prm %>"></script>
