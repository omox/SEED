...
<div id="list" data-options="region:'center',border:false" style="display:none;">
	...
	<input type="checkbox" tabindex="-1" id="<%=DefineReport.Checkbox.URISELKBN.getObj()%>1"/>
	<input type="checkbox" tabindex="-1" id="<%=DefineReport.Checkbox.URISELKBN.getObj()%>2"/>
	<input type="checkbox" tabindex="-1" id="<%=DefineReport.Checkbox.URISELKBN.getObj()%>3"/>
	</div>
</div>
</form>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.SA008.js?v=<%=prm %>"></script>
