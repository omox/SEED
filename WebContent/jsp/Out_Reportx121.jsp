...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<td><input class="easyui-textbox"  id="<%=DefineReport.InpText.TENKN.getObj()%>" check='<%=DefineReport.InpText.TENKN.getMaxlenTag()%>' for_inp="<%=DefineReport.InpText.TENCD.getObj()%>_F3" style="width:370px;" value=""></td>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td><a href="#" title="新規" id="<%=DefineReport.Button.NEW.getObj()%>" class="easyui-linkbutton" tabindex="902" iconCls="icon-add" style="width:125px;"><span class="btnTxt">新規</span></a>
		<a href="#" title="<%=DefineReport.Button.SEL_REFER.getTxt()%>" class="easyui-linkbutton" tabindex="905" id="<%=DefineReport.Button.SEL_REFER.getObj()%>" iconCls="icon-ok" style="width:125px;"><span>選択(参照)</span></a></td>
		<td><a href="#" title="選択(変更)" id="<%=DefineReport.Button.SEL_CHANGE.getObj()%>" class="easyui-linkbutton" tabindex="904" iconCls="icon-ok" style="width:125px;"><span>選択(変更)</span></a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.x121.js?v=<%=prm %>"></script>
