	...
	<tr>
		<td style="width:900px;">
			...
			<div style="float:right;height:20px;padding:3px 20px 0;">
				<label class="chk_lbl" >売価選択禁止<input type="checkbox" col="F9"   value="1" disabled="disabled" /></label><br>
				<label class="chk_lbl" >店不採用禁止<input type="checkbox" col="F10"   value="1" disabled="disabled" /></label><br>
				<label class="chk_lbl" >商品選択禁止<input type="checkbox" col="F11"   value="1" disabled="disabled" /></label><br>
				<label class="chk_lbl" >1日遅ﾊﾟﾀﾝ有 <input type="checkbox" col="F12"   value="1" disabled="disabled" /></label><br>
			</div>
		</td>
	</tr>
	<tr>
...
<div id="list" data-options="region:'center',border:false" style="display:none;">
	...
	<input  class="easyui-numberbox" tabindex="-1" id="<%=DefineReport.InpText.URICHGAM1.getObj()%>"  style="width:80px;" check='<%=DefineReport.InpText.URICHGAM1.getMaxlenTag()%>' />
	<input  class="easyui-numberbox" tabindex="-1" id="<%=DefineReport.InpText.URICHGAM2.getObj()%>"  style="width:80px;"/>
	<input  class="easyui-numberbox" tabindex="-1" id="<%=DefineReport.InpText.URICHGAM3.getObj()%>"  style="width:80px;"/>
	</div>
</div>
</form>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.SA005.js?v=<%=prm %>"></script>
