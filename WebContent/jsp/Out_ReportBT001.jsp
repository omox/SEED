...
<div id="search" data-options="region:'north',border:false" style="display:none;" >
	...
	<tr>
		...
		<td><input class="easyui-combobox" tabindex="1" id="<%=DefineReport.MeisyoSelect.KBN10002.getObj()%>" style="width:100px;"></td>
		<td>催し開始日</td>
		<td><input class="easyui-numberbox" tabindex="2" id="<%=DefineReport.InpText.MOYSSTDT.getObj()%>" check='<%=DefineReport.InpText.MOYSSTDT.getMaxlenTag()%>' style="width:80px;" data-options="prompt:'__/__/__'"></td>
...
<div id="buttons" data-options="region:'south',border:false" style="display:none;height:30px;padding:0 30px;text-align: center;">
	<div class="btn" style="float: left;">
		...
		<td></td>
		<td><a href="#" title="選択(明細)" id="<%=DefineReport.Button.SEL_REFER.getObj()%>" class="easyui-linkbutton" tabindex="7" iconCls="icon-ok" style="width:125px;"><span>選択(明細)</span></a></td>
		</tr>
		</table>
	</div>
</div>
...
<script type="text/javascript" src="../js/jquery.report/jquery.report.option.BT001.js?v=<%=prm %>"></script>
