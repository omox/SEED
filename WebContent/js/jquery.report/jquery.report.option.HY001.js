...
;(function($) {
	...
	$.extend({
		reportOption: {
		name:		'Out_ReportHY001',			// （必須）レポートオプションの確認
		...
		setInitObjectState: function(){	// 画面初期化時の項目制御
			...
			$.initReportInfo("HY001", "予約発注　企画一覧");
		},
...
//			this.success(this.name, false);
		...
		setGrid: function (id, reportNumber){	// グリッドの構築
			...
			$(id).datagrid({
				...
				frozenColumns:[[]],
				columns:[[
					{field:'F1',	title:'企画No',		width:  80,halign:'center',align:'left',rowspan:2,styler:cstyler},
					{field:'F2',	title:'企画名',		width: 400,halign:'center',align:'left',rowspan:2},
					{title:'納入期間',colspan:2},
				],[
					{field:'F3',	title:'開始日',		width: 100,halign:'center',align:'left'},
					{field:'F4',	title:'終了日',		width: 100,halign:'center',align:'left'},
				]],
