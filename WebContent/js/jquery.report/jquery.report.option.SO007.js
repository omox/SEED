...
;(function($) {
	...
	$.extend({
		reportOption: {
		name:		'Out_ReportSO007',			// （必須）レポートオプションの確認
		...
		setInitObjectState: function(){	// 画面初期化時の項目制御
			...
			$.initReportInfo("SO007", "生活応援　CSV取込　エラーリスト", "取込");
			$('#selectLastrow').on("click", function(e){
				that.puchSelectLastRowButton()
			});
		},
...
//			this.success(this.name, false);
		...
		puchSelectLastRowButton: function(){
			var that = this;
			var rows = $($.id.gridholder).datagrid('getRows');
			if(rows){
				$($.id.gridholder).datagrid('selectRow', rows.length-1);
			}
		},
		...
		getGridColumns:function(that, id){
			...
			columnBottom.push({field:'F1',	title:'行番号',			width:  50,halign:'center',align:'left'});
			columnBottom.push({field:'F2',	title:'商品コード',		width: 100,halign:'center',align:'left'});
			columnBottom.push({field:'F3',	title:'商品名',			width: 250,halign:'center',align:'left'});
			columnBottom.push({field:'F4',	title:'エラー箇所',		width:  80,halign:'center',align:'left'});
			columnBottom.push({field:'F5',	title:'エラー理由',		width: 600,halign:'center',align:'left'});
			columnBottom.push({field:'F6',	title:'エラー値',		width:  80,halign:'center',align:'left'});
