...
;(function($) {
	...
	$.extend({
		reportOption: {
		name:		'Out_Reportx041',			// （必須）レポートオプションの確認
		...
		setInitObjectState: function(){	// 画面初期化時の項目制御
			...
			$.initReportInfo("LT001", "リードタイムマスタ　一覧");
		},
...
//			this.success(this.name, false);
		...
		setGrid: function (id, reportNumber){	// グリッドの構築
			...
			$(id).datagrid({
				...
				frozenColumns:[[]],
				columns:[[
				    {field:'F1',	title:'リードタイムパターン',		width: 90,halign:'center',align:'left'},
				    {field:'F2',	title:'リードタイム名称',			width:200,halign:'center',align:'left'},
					{field:'F3',	title:'リードタイム月',				width: 50,halign:'center',align:'right'},
					{field:'F4',	title:'リードタイム火',				width: 50,halign:'center',align:'right'},
					{field:'F5',	title:'リードタイム水',				width: 50,halign:'center',align:'right'},
					{field:'F6',	title:'リードタイム木',				width: 50,halign:'center',align:'right'},
					{field:'F7',	title:'リードタイム金',				width: 50,halign:'center',align:'right'},
					{field:'F8',	title:'リードタイム土',				width: 50,halign:'center',align:'right'},
					{field:'F9',	title:'リードタイム日',				width: 50,halign:'center',align:'right'},
					{field:'F10',	title:'オペレータ',					width:105,halign:'center',align:'left'},
					{field:'F11',	title:'登録日',						width: 70,halign:'center',align:'right'},
					{field:'F12',	title:'更新日',						width: 70,halign:'center',align:'right'},
				]],
