...
;(function($) {
	...
	$.extend({
		reportOption: {
		name:		'Out_Reportx121',			// （必須）レポートオプションの確認
...
//			this.success(this.name, false);
		...
		setGrid: function (id, reportNumber){	// グリッドの構築
			...
			$(id).datagrid({
				...
				frozenColumns:[[]],
				columns:[[
					{field:'F1',	title:'部門',				width: 100,halign:'center',align:'left'},
					{field:'F2',	title:'部門名',				width: 300,halign:'center',align:'left'}
				]],
