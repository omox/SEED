...
$.extend({
	...
	winTJ002: {
		...
		callBtnid: "",			// 呼出ボタンID情報
		focusRootId:"_winTJ002",// （キー移動時必須）キー移動イベントのルートとなるパネルのID
		...
		Open: function(obj) {
			...
			case 'Out_ReportTJ001':
				...
				// オブジェクト作成
				$('#'+that.suffix).window({title: '特売販売計画＆事前発注 大分類構成比(TJ002)'});
